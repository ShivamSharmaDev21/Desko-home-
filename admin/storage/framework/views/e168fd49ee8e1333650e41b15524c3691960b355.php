...
unset($__errorArgs, $__bag); ?>
											...
											<div class="col-12 ">
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control whichKey" name="short_note" rows="5" id="short_note" placeholder="Enter the short note " data-phrasetype="objective"><?php echo e(!empty($smart_feature->short_note ) ? $smart_feature->short_note : ''); ?></textarea>
                                                 </div>
                                            </div>
									</div>
										<div class="row row-sm">
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/desko2023/public_html/devvsh/admin/resources/views/edit_smart_feature.blade.php ENDPATH**/ ?>