<?php $__env->startSection('body'); ?>
        ...
        <div class="container-fluid">
            <div class="inner-body">
                ...
                <div class="page-header">
                    <div>
                        <h2 class="main-content-title tx-24 mg-b-5">Feature Image</h2>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="#">Feature Image</a></li>
                            <li class="breadcrumb-item active" aria-current="page">View Feature Image </li>
                        </ol>
                    </div>
                ...
                <div class="row row-sm">
                    <div class="col-lg-12 col-md-12">
                        <div class="card custom-card">
                            <div class="card-body">
                                <div>
                                    <h6 class="main-content-label mb-1">Feature Image List</h6>
                                        ...
                                        <div class="table-responsive">
                                            <table id="exportexample"
                                                ...
                                                <tbody>
                                                    ...
                                                    <?php $__currentLoopData = $feature; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <tr>
                                                            <td><?php echo e($i); ?></td>

                                                            <td><img src="<?php echo e(url('public/feature_image_home/' . $s->image)); ?>"
                                                                    width="50" height="50"></td>

                                                           
                                                            <td><a href="<?php echo e(url('edit_fih/' . $s->id)); ?>"
    ...
    <script>
        function change_status(smart_id, str) {
            //alert(smart_id+'='+str);
            $.ajax({
                url: "<?php echo e(url('change_feature_image_home_status')); ?>",
                type: 'post',
                data: {
                    str: str,
                    smart_id: smart_id,
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/admin/resources/views/view_feature_image_home.blade.php ENDPATH**/ ?>