...
<script>
    setTimeout(function(){
       $('.remove_alert').fadeOut();;
										...
										<form action="<?php echo e(url('store_material')); ?>" method="post" >
										    <?php echo csrf_field(); ?>
										<div class="row row-sm">
                                          	
											<div class="col-md-4 mb-2">
    										    <div class="form-floating mb-3">
        											 <input type="text" name="material_name" value="<?php echo e(old('material_name')); ?>" required class="form-control" id="floatingInput" placeholder="name@example.com" >
...
unset($__errorArgs, $__bag); ?>
											...
											<!--<div class="col-md-4 mb-2">-->
        			<!--							<div class="form-floating mb-3">-->
        			<!--								 <input type="text" name="material_price" value="<?php echo e(old('material_price')); ?>" required class="form-control" id="floatingInput" placeholder="name@example.com" >-->
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/cwsinnim/public_html/deskohome/admin/resources/views/add_material.blade.php ENDPATH**/ ?>