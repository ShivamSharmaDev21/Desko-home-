       ...
       $('.remove_alert').fadeOut();;
		...
		<script>
		    function  change_status_customized(prod_id,str){
		      $.ajax({
                url: "<?php echo e(url('change_status_customized')); ?>",
                type: 'post',
                data: {
                    str:str,
                    prod_id:prod_id,
		  ...
		  //    $.ajax({
    //             url: "<?php echo e(url('change_status_image')); ?>",
    //             type: 'post',
    //             data: {
    //                 str:str,
    //                 prod_id:prod_id,
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/desko2023/public_html/devvsh/admin/resources/views/view_products.blade.php ENDPATH**/ ?>