					...
					<div class="inner-body">
                     <!-- Page Header -->
						<div class="page-header">
							<div>
								<h2 class="main-content-title tx-24 mg-b-5">Banner List</h2>
								<ol class="breadcrumb">
							...
							<div class="d-flex">
								<div class="justify-content-center">
									...
									<a href="<?php echo e(url('add_banner')); ?>" class="btn btn-primary my-2 btn-icon-text">
									 Add Banner
									</a>
								</div>
							</div>
					...
					<div class="row row-sm">
							<div class="col-lg-12 col-md-12">
								<div class="card custom-card">
									<div class="card-body">
										<div>
											<h6 class="main-content-label mb-1">Banner List</h6>
										...
										<div class="table-responsive">
											<table id="exportexample" class="table text-center table-bordered border-t0 key-buttons text-nowrap w-100" >
											 ...
											 <?php $__currentLoopData = $banners; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $banner): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
												...
												<td><img src="<?php echo e(url('/public/banners/'.$banner->img)); ?>" width="50" height="50"></td>
											
												<td><a href="<?php echo e(url('edit_banner/'.$banner->id)); ?>" class="btn btn-primary">Edit</a></td>
                <td>
                    <form action="<?php echo e(url('delete_banner/'.$banner->id)); ?>" method="POST">
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/cws/public_html/goodwill_academy/resources/views/view_banners.blade.php ENDPATH**/ ?>