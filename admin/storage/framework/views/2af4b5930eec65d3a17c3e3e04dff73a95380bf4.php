...
<!--<div class="header-fixed-placeholder"></div>-->
    <main>
        ...
        <section class="row the-hero" style="background-image : url('public/slider_image_home/<?php echo e($slider->image); ?>');
                ...
                <div class="row justify-content-center dflex">
                    <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="col-md-6 text-center hoverAni">
                            <img src="public/feature_image/<?php echo e($product->feature_image); ?>" class="wow fadeInDown my-fe"
                                data-wow-delay="0.3s">
...
">
        ...
        <!--====== Contact Area Start ======-->
         <section class="row left-right-contents" style="background-image : url('public/feature_image_home/<?php echo e($feature->image); ?>');
                        ...
                        <div class="row justify-content-center d-flex align-items-center shad my-bott">
                            ...
                            <div class="col-md-6 p-0">
                                <div class="wow fadeInDown" data-wow-delay="0.3s">
                                    <img src="public/msg_image_home/<?php echo e($m->image); ?>" class="msg-home">
                                </div>
                            </div>
                        </div>
                    <?php endif; ?>
...
<?php /**PATH /home/desko2023/public_html/development/admin/resources/views/index_home.blade.php ENDPATH**/ ?>