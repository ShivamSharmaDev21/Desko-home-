...
<script>
    setTimeout(function(){
       $('.remove_alert').fadeOut();;
               	...
               	<td><?php echo e($order['order_details']->address.' Email -'.$order['order_details']->email.' contact -'.$order['order_details']->mobile.'State - '.$order['order_details']->state_name.'City - '.$order['order_details']->city_name); ?></td>
												</tr>
												<?php $i++; ?>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/desko2023/public_html/development/admin/resources/views/view_orders.blade.php ENDPATH**/ ?>