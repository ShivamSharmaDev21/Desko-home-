	           ...
	           <div class="row row-sm"> 
							<div class="col-lg-12 col-md-12">
								<div class="card custom-card">
									<div class="card-body">
										<div>
											<h6 class="main-content-label mb-1"> Add Video </h6>
...
<div>
 <?php if(Session::get('success')): ?>
    ...
    <?php endif; ?>
										...
										<form action="<?php echo e(url('store_video')); ?>" method="post" >
										    <?php echo csrf_field(); ?>
										<div class="row row-sm">
                                          	
											<div class="col-md-4 mb-2">
										    <div class="form-floating mb-3">
											 <input type="text" value="<?php echo e(old('title')); ?>" class="form-control" id="floatingInput" placeholder="name@example.com" name="title">
...
unset($__errorArgs, $__bag); ?>
										...
										<div class="col-md-4  mb-2">
											<div class="form-floating mb-3">
											<input type="text" value="<?php echo e(old('url')); ?>" class="form-control" id="floatingInput" placeholder="name@example.com" name="url">
									...
									<div class="row row-sm-12">
										    ...
										    <div class="form-floating mb-3">
											 <!--<input type="text" value="<?php echo e(old('description')); ?>" class="form-control" id="floatingInput" placeholder="name@example.com" name="description">-->
										        <textarea name="description" class="form-control" id="floatingInput" ></textarea>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/cws/public_html/goodwill_academy/resources/views/add_video.blade.php ENDPATH**/ ?>