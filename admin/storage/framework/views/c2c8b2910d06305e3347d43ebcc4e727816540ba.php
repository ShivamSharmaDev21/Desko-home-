						...
						<div class="page-header">
							...
							<div class="d-flex">
								<div class="justify-content-center">
									...
									<a href="<?php echo e(url('add_smart_feature')); ?>" class="btn btn-primary my-2 btn-icon-text">
									 Add Smart Feature
									</a>
								</div>
							</div>
    ...
    setTimeout(function(){
       $('.remove_alert').fadeOut();;
									 ...
									 <div class="col-lg-12 col-md-12">
										<div class="table-responsive">
											<table id="exportexample" class="table text-center table-bordered border-t0 key-buttons text-nowrap w-100" >
												...
												<tbody>
												    <?php $i=1; ?>
											 <?php $__currentLoopData = $smart_features; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
										
												<tr>
												<td><?php echo e($i); ?></td>
												<td><?php echo e($s->feature_name); ?></td>
												<td><img src="<?php echo e(url('/smart_feature_image/'.$s->image)); ?>" width="50" height="50"></td>
											    ...
											    <td>
                                                      <input onchange="change_sequence(<?php echo $s->id?>,this.value)" type="number" id="sl_number" name="sl_number" value=<?php echo e($s->sl_number); ?>> 
 											     </td>
												<td><a href="<?php echo e(url('edit_smart_feature/'.$s->id)); ?>" class="btn btn-primary">Edit</a></td>
                <td>
                    <form action="<?php echo e(url('delete_smart_feature/'.$s->id)); ?>" method="POST">
                        <?php echo csrf_field(); ?>
	    ...
	    function  change_status(smart_id,str){
	       //alert(smart_id+'='+str);
	      $.ajax({
            url: "<?php echo e(url('change_smart_feature_status')); ?>",
            type: 'post',
            data: {
                str:str,
                smart_id:smart_id,
	    ...
	    function  change_sequence(smart_id,str){
	        $.ajax({
            url: "<?php echo e(url('change_sequence_smart_feature')); ?>",
            type: 'post',
            data: {
                str:str,
                smart_id:smart_id,
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/desko2023/public_html/devvsh/admin/resources/views/view_smart_features.blade.php ENDPATH**/ ?>