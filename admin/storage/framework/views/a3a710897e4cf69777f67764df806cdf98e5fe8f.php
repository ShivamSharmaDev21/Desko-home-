...
<script>
    setTimeout(function(){
       $('.remove_alert').fadeOut();;
										...
										<form action="<?php echo e(url('store_product')); ?>" method="post" enctype="multipart/form-data" >
										    <?php echo csrf_field(); ?>
										<div class="row row-sm">
                                          	
											<div class="col-md-6 mb-2">
										        <div class="form-floating mb-3">
    											    <input type="text"  name="prod_name" value="<?php echo e(old('prod_name')); ?>" required class="form-control" id="floatingInput" placeholder="Product name">
...
unset($__errorArgs, $__bag); ?>
											...
											<div class="col-md-6 mb-2">
										        <div class="form-floating mb-3">
    											    <input type="number"  name="minimum_price" value="<?php echo e(old('minimum_price')); ?>" required class="form-control" id="floatingInput" placeholder="Minimum price">
...
unset($__errorArgs, $__bag); ?>
											...
											<div class="col-md-6 mb-2">
										        <div class="form-floating mb-3">
    											    <input type="number"  name="maximum_price" value="<?php echo e(old('maximum_price')); ?>" required class="form-control" id="floatingInput" placeholder="Maximum price">
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/desko2023/public_html/development/admin/resources/views/add_product.blade.php ENDPATH**/ ?>