...
unset($__errorArgs, $__bag); ?>
											...
											<div class="col-md-4 mt-2 mb-2">
										        <div class="form-floating mb-3">
    											    <input type="number"  name="bottom_price" value="<?php echo e(old('bottom_price')); ?>"  id="bottom_price" required class="form-control" id="floatingInput" placeholder="Bottom price">
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/cwsinnim/public_html/deskohome/admin/resources/views/add_desk_bottom.blade.php ENDPATH**/ ?>