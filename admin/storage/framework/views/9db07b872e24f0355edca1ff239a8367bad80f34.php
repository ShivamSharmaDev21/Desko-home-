    ...
    <div class="main-content side-content pt-0">
        <div class="container-fluid">
            <div class="inner-body">
                ...
                <form action="<?php echo e(url('store_review_home')); ?>" method="post" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    <!-- End Page Header -->
                    <div class="row row-sm">
                        <div class="col-lg-12 col-md-12">
                            <div class="card custom-card">
                                <div class="card-body">
                                    <div>
                                        <h6 class="main-content-label mb-1"> Add Review </h6>
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="col-md-12 mb-2">
                                            <div class="form-floating mb-3">
                                                ...
                                                <textarea name="description" class="form-control"  rows="3" style="height: 100px;"placeholder="Enter Review description"></textarea>
                                                ...
                                                <div class="col-md-12 mb-2">
                                                    <div class="form-floating mb-3">
                                                        <input type="text" name="dsg"
                                                            value="<?php echo e(old('dsg')); ?>" required class="form-control"
                                                            id="floatingInput" placeholder="Slider name">
                                                        <label for="floatingInput">Reviewer's Designation</label>
                                                        <?php $__errorArgs = ['dsg'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/admin/resources/views/add_review_home.blade.php ENDPATH**/ ?>