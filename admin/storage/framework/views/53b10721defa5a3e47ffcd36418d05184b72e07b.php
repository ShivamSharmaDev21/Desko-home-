    ...
    <div class="main-content side-content pt-0">
        <div class="container-fluid">
            <div class="inner-body">
                ...
                <form action="<?php echo e(url('store_faq_home')); ?>" method="post" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    <!-- End Page Header -->
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/admin/resources/views/add_faq_home.blade.php ENDPATH**/ ?>