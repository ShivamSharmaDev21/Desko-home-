                ...
                <div class="page-header">
                    ...
                    <div class="d-flex">
                        <div class="justify-content-center">
                            ...
                            <a href="<?php echo e(url('add_msg_home')); ?>" class="btn btn-primary my-2 btn-icon-text">
                                Add Message
                            </a>
                        </div>
                    </div>
                                        ...
                                        <div class="table-responsive">
                                            <table id="exportexample"
                                                ...
                                                <tbody>
                                                    ...
                                                    <?php $__currentLoopData = $msg; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <tr>
                                                            <td><?php echo e($i); ?></td>
                                                            <td><?php echo e($s->title); ?></td>
                                                          
                                                        
                                                            <td><img src="<?php echo e(url('public/msg_image_home/' . $s->image)); ?>"
                                                                    width="50" height="50"></td>

                                                           
                                                            <td><a href="<?php echo e(url('edit_msg_home/' . $s->id)); ?>"
                                                                    class="btn btn-primary">Edit</a></td>
                                                            <td>
                                                                <form action="<?php echo e(url('delete_msg_home/' . $s->id)); ?>"
                                                                    method="POST">
                                                                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/desko2023/public_html/development/admin/resources/views/view_msg_home.blade.php ENDPATH**/ ?>