...
unset($__errorArgs, $__bag); ?>
											...
											<div class="col-md-6 mb-2">
										        <div class="form-floating mb-3">
    											    <input type="text"  name="url" value="<?php echo e($product->url); ?>" required class="form-control" id="floatingInput" placeholder="Product Url">
    											    <!--<input type="hidden"  name="url" value="<?php echo e($product->prod_id); ?>"  class="form-control" id="floatingInput" placeholder="Product Url">-->
...
unset($__errorArgs, $__bag); ?>
											...
											<div class="col-md-6 mb-2">
										        <div class="form-floating mb-3">
											        ...
											        <input type="hidden"  name="is_customized_image_hidden"  value="<?php echo e($product->is_customized_imageis_customized_image); ?>"  class="form-control" id="is_customized_image_hidden" placeholder="Customized Image">
										                <span class="text-danger">(accept-.png,.jpg,.jpeg)</span>
...
unset($__errorArgs, $__bag); ?>
											...
											<div class="col-md-6 mb-2">
										        <div class="form-floating mb-3">
											       <img src="<?php echo e(URL::asset('public/feature_image/'.$product->is_customized_image)); ?>"  height="50px"width="50px" >
												</div>
											</div>
...
<script>
  ClassicEditor
    ...
    function delete_image( id ){
        $.ajax({
            url: "<?php echo e(url('delete_product_img')); ?>",
            type: 'post',
            data: {
                id:id,
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/desko2023/public_html/admin/resources/views/edit_product.blade.php ENDPATH**/ ?>