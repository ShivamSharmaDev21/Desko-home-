                ...
                <div class="row justify-content-center dflex">
                    <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="col-md-6 text-center hoverAni">
                            ...
                            <a href="https://cws.in.net/deskohome/product-detail/<?=$product->prod_id?>" class="button-link wow fadeInUp" 
                            ...
                            <div class="card product-card text-center rounded">
                                ...
                                <div class="product-order">
                                    ...
                                    <div class="order-btn d-flex flex-wrap justify-content-center">
                                        <a class="prolend-primary style-two m-2" href="https://cws.in.net/deskohome/product-detail/<?=$product->prod_id?>">Shop Now</a>
                                    </div>
                                </div>
                            </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="row justify-content-center d-flex">
                    <div class="col-12 col-md-10">
                        ...
                        <div class="contact-box text-center">
                            <!-- Contact Form -->
                           <form id="contact-form" method="POST" action="https://cws.in.net/deskohome/contact-us-form">
...
<?php /**PATH /home/cwsinnim/public_html/deskohome/admin/resources/views/index_home.blade.php ENDPATH**/ ?>