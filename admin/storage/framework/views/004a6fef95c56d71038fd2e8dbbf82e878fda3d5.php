				...
				<div class="main-sidebar-body">
					<ul class="nav">
						...
						<!--</li>-->
							...
							<li class="nav-item">
						    <a class="nav-link" href="<?php echo e(url('addNumber')); ?>"><span class="shape1"></span><span class="shape2"></span><i class="si si-people sidemenu-icon"></i><span class="sidemenu-label">Whatsapp</span></a>
						</li>
						</li>
							<li class="nav-item">
    						  <a class="nav-link" href="<?php echo e(url('coupons_list')); ?>">
...
</html><?php /**PATH /home/desko2023/public_html/devvsh/admin/resources/views/include/header.blade.php ENDPATH**/ ?>