                ...
                <div class="page-header">
                    ...
                    <div class="d-flex">
                        <div class="justify-content-center">
                            ...
                            <a href="<?php echo e(url('/view_slider_home')); ?>" class="btn btn-primary my-2 btn-icon-text">
                                Slider List
                            </a>
                        </div>
                    </div>
                </div>
                <form action="<?php echo e(url('store_slider_home')); ?>" method="post" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    <!-- End Page Header -->
                                    ...
                                    <div class="row row-sm">
                                        ...
                                        <div class="col-md-6 mb-2">
                                            <div class="form-floating mb-3">
                                                <input type="text" name="slider_name" value="<?php echo e(old('slider_name')); ?>"
                                                ...
                                                <div class="col-md-12 mb-2">
                                                    <div class="form-floating mb-3">
                                                        <input type="text" name="btn1_caption"
                                                            value="<?php echo e(old('slider_name')); ?>" required class="form-control"
                                                ...
                                                <div class="col-md-12 mb-2">
                                                    <div class="form-floating mb-3">
                                                        <input type="text" name="btn2_caption"
                                                            value="<?php echo e(old('slider_name')); ?>" required
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/admin/resources/views/add_slider_home.blade.php ENDPATH**/ ?>