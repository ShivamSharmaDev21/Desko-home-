        ...
        <div class="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
          ...
          <div class="navbar-header mb-5" style="width:100%">
              <div class="navbar-brand footer-nav" ><a href="<?php echo e(url('/')); ?>">
                  <img src="<?php echo e(URL::asset('public/frontend/assets/img/desko_logo.png')); ?>" alt="Image" style="width: 110px;
...
<!-- Footer -->
  ...
  <!--<script src="<?php echo e(asset('public/frontend/assets/js/main2.js')); ?>"></script>-->
 <script>
...
</html><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/admin/resources/views/frontend/include/footer.blade.php ENDPATH**/ ?>