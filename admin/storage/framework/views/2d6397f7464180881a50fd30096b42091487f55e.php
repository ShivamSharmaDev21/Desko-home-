						...
						<div class="page-header">
							...
							<div class="d-flex">
								<div class="justify-content-center">
									...
									<a href="<?php echo e(url('add_category')); ?>" class="btn btn-primary my-2 btn-icon-text">
									 Add Category
									</a>
								</div>
							</div>
       ...
       $('.remove_alert').fadeOut();;
											...
											<table id="exportexample" class="table text-center table-bordered border-t0 key-buttons text-nowrap w-100" >
											 ...
											 <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
												...
												<td><?php echo e(date('d-m-Y',strtotime($cat->updated_at))); ?></td>
												 <td>
                   <a href="<?php echo e(url('edit_category/'.$cat->cat_id)); ?>"class="btn btn-primary">Edit</a>
                </td>
											
                <td>
                    <form action="<?php echo e(url('delete_category/'.$cat->cat_id)); ?>" method="POST">
                        <?php echo csrf_field(); ?>
		...
		<script>
		    function  change_status(cat_id,str){
		        //alert(cat_id+'='+str);
		      $.ajax({
                url: "<?php echo e(url('change_category_status')); ?>",
                type: 'post',
                data: {
                    str:str,
                    cat_id:cat_id,
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/cwsinnim/public_html/deskohome/admin/resources/views/view_categories.blade.php ENDPATH**/ ?>