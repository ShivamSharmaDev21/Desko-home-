    ...
    <div class="main-content side-content pt-0">
        <div class="container-fluid">
            <div class="inner-body">
                ...
                <!-- End Page Header -->
                <form action="<?php echo e(url('store_feature_image_home')); ?>" method="post" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                                            ...
                                            <div class="col-md-12 mb-2">
                                                <div class="form-floating mb-3">
                                                    <input type="text" name="heading1"
                                                        value="<?php echo e(old('heading1')); ?>" required class="form-control"
                                                ...
                                                <div class="col-md-12 mb-2">
                                                    <div class="form-floating mb-3">
                                                        <input type="text" name="heading2"
                                                            value="<?php echo e(old('heading2')); ?>" required class="form-control"
                                                            id="floatingInput" placeholder="Heading Name">
                                                        <label for="floatingInput">Heading Name</label>
                                                    ...
                                                    <div class="col-md-12 mb-2">
                                                        <div class="form-floating mb-3">
                                                            <input type="text" name="heading3"
                                                                value="<?php echo e(old('heading3')); ?>" required
                                                        ...
                                                        <div class="col-md-12 mb-2">
                                                            <div class="form-floating mb-3">
                                                                <input type="text" name="heading4"
                                                                    value="<?php echo e(old('heading4')); ?>" required
                                                                    class="form-control" id="floatingInput"
                                                                    placeholder="Heading Name">
                                                                <label for="floatingInput">Heading Name</label>
                                                            ...
                                                            <div class="col-md-12 mb-2">
                                                                <div class="form-floating mb-3">
                                                                    <input type="text" name="heading5"
                                                                        value="<?php echo e(old('heading5')); ?>" required
                                                                        class="form-control" id="floatingInput"
                                                                        placeholder="Heading Name">
                                                                    <label for="floatingInput">Heading Name</label>
                                                                ...
                                                                <div class="col-md-12 mb-2">
                                                                    <div class="form-floating mb-3">
                                                                        <input type="text" name="heading6"
                                                                            value="<?php echo e(old('heading6')); ?>" required
                                                                            class="form-control" id="floatingInput"
                                                                            placeholder="Heading Name">
                                                                        <label for="floatingInput">Heading Name</label>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/admin/resources/views/add_feature_image_home.blade.php ENDPATH**/ ?>