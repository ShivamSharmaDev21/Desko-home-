									...
									<div class="row row-sm">
									 <div class="col-lg-12 col-md-12">
										<div class="table-responsive">
										    <!--<button id="leadexcelfiledownload" onclick="leadexcelfiledownloadFunction()" href="{{ url('download_lead') }}">Export File </button>-->
											<table id="exportexample"class="table text-center table-hover border-t0 key-buttons text-nowrap w-100" >
											 ...
											 @foreach($orders as $order)
												...
												<td> <a href="{{url('/public/capture_desk_image').'/'.$order->image}}">View Desk  </a></td>
