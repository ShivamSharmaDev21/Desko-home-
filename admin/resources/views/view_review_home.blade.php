                ...
                <div class="page-header">
                    ...
                    <div class="d-flex">
                        <div class="justify-content-center">
                            ...
                            <a href="{{ url('add_review_home') }}" class="btn btn-primary my-2 btn-icon-text">
                                Add Review
                            </a>
                        </div>
                    </div>
                                                ...
                                                <tbody>
                                                    ...
                                                    @foreach ($review as $s)
                                                        <tr>
                                                            ...
                                                            <td>{{ $s->description }}</td>
                                                            <td>{{ $s->name }}</td>
                                                            <td><img src="{{ url('public/review_image_home/' . $s->image) }}"
                                                                    width="50" height="50"></td>

                                                           
                                                            <td><a href="{{ url('edit_review_home/' . $s->id) }}"
                                                                    class="btn btn-primary">Edit</a></td>
                                                            <td>
                                                                <form action="{{ url('delete_review_home/' . $s->id) }}"
                                                                    method="POST">
                                                                    @csrf
                                                                    @method('DELETE')
