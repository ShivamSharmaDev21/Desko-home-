...
<script>
    setTimeout(function(){
       $('.remove_alert').fadeOut();;
										...
										<form action="{{url('update_desk_bottom')}}" method="post" enctype="multipart/form-data" >
										    @csrf
										     @method('PUT')
										<div class="row row-sm">
											...
											<div class="col-lg-4 mb-2">
                                                <select name="bottom_material"   class="selectpicker form-control" id="number-multiple" data-container="body" data-live-search="true" title="Select Top Material" data-hide-disabled="true" data-actions-box="true" data-virtual-scroll="false">
                                                    @foreach($materials as $mat)
            											 <option value="{{$mat->id}}"<?=($mat->id==$deskbottom->bottom_material)?'selected':''?>>{{$mat->material_name}}</option>
            											 @endforeach
                                                 </select>
                                            ...
                                            <div class="col-md-4 mt-2 mb-2">
										        <div class="form-floating mb-3">
    											    <input type="text"  name="bottom_name" value="{{$deskbottom->bottom_name}}" required class="form-control" id="floatingInput" placeholder="Bottom name ">
    											    <input type="hidden"  name="bottom_id" value="{{$deskbottom->bottom_id}}" required class="form-control" id="floatingInput" placeholder="Bottom name ">
											...
											<div class="col-md-4 mt-2 mb-2">
										        <div class="form-floating mb-3">
    											    <input type="number"  name="bottom_price" value="{{$deskbottom->bottom_price}}"  id="bottom_price" required class="form-control" id="floatingInput" placeholder="Bottom price">
									 ...
									 <div class="row">
                                        <div class="col-lg-3 mb-2">
											     <div class="form-floating mb-3">
    											    <input type="text"  name="bottomclr" value="{{$btg->colour_name}}"readonly="readonly"  class="form-control" id="floatingInput" placeholder="Top name ">
										 ...
										 <img src="{{URL::asset('public/desk_bottom_image/'.$btg->image)}}" height="50px"width="50px">
											</div>
											<div class="col-md-1 ">
                                                <a href="{{url('remove_desk_bottomgall/'.$deskbottom->bottom_id.'/'.$btg->id)}}" id="remove_image" type="button"  class="btn btn-danger">Remove</a>
                                    	    </div>
								</div>
									<?php } } ?>
										 <div class="row">
								 ...
								 <div id="newRow"></div>
											...
											<div class="col-md-12 ">
										        <div class="form-floating mb-3">
    										         ...
    										         <textarea name="bottom_description" class="form-control" id="editor" rows="3" style="height: 100px;" placeholder="Enter  Description">{{$deskbottom->bottom_description}}</textarea>
										...
										<div class="row row-sm">
											<div class="col-md-6">
												...
												<a href="{{url('/view_desk_bottom')}}" class="btn ripple btn-outline-danger pd-x-30">Cancel</a>
											</div>
										</div>
										</form>
									</div>
