        ...
        <!-- Sidemenu -->
			<div class="main-sidebar main-sidebar-sticky side-menu">
				<div class="sidemenu-logo">
					<a class="main-logo" href="3">
						<img src="{{asset('public/assets/img/desko_logo.png')}}" class="header-brand-img desktop-logo" alt="logo">
						 <!--<img src="{{asset('assets/img/logohaff.png')}}" class="header-brand-img icon-logo"-->
				...
				<div class="main-sidebar-body">
					<ul class="nav">
						<li class="nav-item">
							<a class="nav-link" href="{{url('/dashboard')}}"><span class="shape1"></span><span class="shape2"></span><i class="ti-home sidemenu-icon"></i><span class="sidemenu-label">Dashboard</span></a>
						</li>
						<!--<li class="nav-item">-->
						...
						<!--			<a class="nav-sub-link" href="{{url('/add_category')}}"> Add Category</a>-->
						<!--		   </li>-->
						<!--		  <li class="nav-sub-item">-->
						<!--			<a class="nav-sub-link" href="{{url('/view_categories')}}">View Category</a>-->
						<!--		</li>-->
						<!--	</ul>-->
						<!--</li>-->
						<li class="nav-item">
							...
							<ul class="nav-sub">
								 <li class="nav-sub-item">
									<a class="nav-sub-link" href="{{url('/add_product')}}"> Add Product</a>
								   </li>
								  <li class="nav-sub-item">
									<a class="nav-sub-link" href="{{url('/view_products')}}">View Products</a>
								</li>
								 <li class="nav-sub-item">
									<a class="nav-sub-link" href="{{url('/view_deactivated_products')}}">Deactivated Products</a>
								</li>
						...
						<li class="nav-item">
							...
							<ul class="nav-sub">
								 <li class="nav-sub-item">
									<a class="nav-sub-link" href="{{url('/edit_slider_home/1')}}"> Update Slider</a>
								   </li>
						...
						<li class="nav-item">
							...
							<ul class="nav-sub">
								 <li class="nav-sub-item">
									<a class="nav-sub-link" href="{{url('/view_form_home')}}"> View Contact Form</a>
								   </li>
						...
						<li class="nav-item">
							...
							<ul class="nav-sub">
								 <li class="nav-sub-item">
									<a class="nav-sub-link" href="{{url('/add_review_home')}}"> Add Review</a>
								   </li>
								  <li class="nav-sub-item">
									<a class="nav-sub-link" href="{{url('/view_review_home')}}">Edit Review</a>
								</li>
								 <li class="nav-sub-item">
									<a class="nav-sub-link" href="{{url('/view_review_home')}}">Delete Review</a>
								</li>
						...
						<li class="nav-item">
							...
							<ul class="nav-sub">
								 <li class="nav-sub-item">
									<a class="nav-sub-link" href="{{url('/add_msg_home')}}"> Add Message</a>
								   </li>
								  <li class="nav-sub-item">
									<a class="nav-sub-link" href="{{url('/view_msg_home')}}">Edit Message</a>
								</li>
								 <li class="nav-sub-item">
									<a class="nav-sub-link" href="{{url('/view_msg_home')}}">Delete Message</a>
								</li>
						...
						<li class="nav-item">
							...
							<ul class="nav-sub">
								 <li class="nav-sub-item">
									<a class="nav-sub-link" href="{{url('/add_faq_home')}}"> Add FAQ</a>
								   </li>
								  <li class="nav-sub-item">
									<a class="nav-sub-link" href="{{url('/view_faq_home')}}">Edit FAQ</a>
								</li>
								 <li class="nav-sub-item">
									<a class="nav-sub-link" href="{{url('/view_faq_home')}}">Delete FAQ</a>
								</li>
						...
						<li class="nav-item">
							...
							<ul class="nav-sub">
								 <li class="nav-sub-item">
									<a class="nav-sub-link" href="{{url('/edit_fih/1')}}"> Update Feature Image</a>
								   </li>
						...
						<li class="nav-item">
							...
							<ul class="nav-sub">
								 <li class="nav-sub-item">
									<a class="nav-sub-link" href="{{url('/edit_video_home/1')}}"> Update Video</a>
								   </li>
						...
						<li class="nav-item">
						    <a class="nav-link" href="{{url('/view_all_orders')}}"><span class="shape1"></span><span class="shape2"></span><i class="fas fa-shopping-cart sidemenu-icon"></i><span class="sidemenu-label">Orders</span></a>
						<!--</li>-->
						<!--	<li class="nav-item">-->
						<!--    <a class="nav-link" href="{{url('view_users')}}"><span class="shape1"></span><span class="shape2"></span><i class="si si-people sidemenu-icon"></i><span class="sidemenu-label">Users</span></a>-->
						<!--</li>-->
						</li>
							<li class="nav-item">
						    <a class="nav-link" href="{{url('addNumber')}}"><span class="shape1"></span><span class="shape2"></span><i class="si si-people sidemenu-icon"></i><span class="sidemenu-label">Whatsapp</span></a>
						</li>
						</li>
							<li class="nav-item">
    						  <a class="nav-link" href="{{url('coupons_list')}}">
    						        <span class="shape1"></span>
    						        <span class="shape2"></span>
    						        <!--<i class="fa-solid fa-sidebar"></i>-->
    						        <span class="sidemenu-label">Coupon</span>
    						  </a>
						    </li>
						</li>
							<li class="nav-item">
						    <a class="nav-link" href="{{url('leads')}}"><span class="shape1"></span><span class="shape2"></span><i class="si si-people sidemenu-icon"></i><span class="sidemenu-label">Leads</span></a>
						</li>
						<li class="nav-item">
							...
							<ul class="nav-sub">
								 <li class="nav-sub-item">
									<a class="nav-sub-link" href="{{url('view_smart_feature')}}">View Smart Feature</a>
								   </li>
								  <li class="nav-sub-item">
									<a class="nav-sub-link" href="{{url('add_smart_feature')}}">Add Smart Feature</a>
								</li>
							</ul>
						</li>
							<li class="nav-item">
							...
							<ul class="nav-sub">
								 <li class="nav-sub-item">
									<a class="nav-sub-link" href="{{url('view_colours')}}">View Colours</a>
								   </li>
								  <li class="nav-sub-item">
									<a class="nav-sub-link" href="{{url('add_colour')}}">Add Colour</a>
								</li>
							</ul>
						</li>
							<li class="nav-item">
							...
							<ul class="nav-sub">
								 <li class="nav-sub-item">
									<a class="nav-sub-link" href="{{url('view_materials')}}">View Materials</a>
								   </li>
								  <li class="nav-sub-item">
									<a class="nav-sub-link" href="{{url('add_material')}}">Add Material</a>
								</li>
							</ul>
						</li>
							<li class="nav-item">
							...
							<ul class="nav-sub">
								 <li class="nav-sub-item">
									<a class="nav-sub-link" href="{{url('view_desk_top')}}">View Desk Top</a>
								   </li>
								  <li class="nav-sub-item">
									<a class="nav-sub-link" href="{{url('add_desk_top')}}">Add Desk Top</a>
								</li>
							</ul>
						</li>
							<li class="nav-item">
							...
							<ul class="nav-sub">
								 <li class="nav-sub-item">
									<a class="nav-sub-link" href="{{url('view_desk_bottom')}}">View Desk Bottom</a>
								   </li>
								  <li class="nav-sub-item">
									<a class="nav-sub-link" href="{{url('add_desk_bottom')}}">Add Desk Bottom</a>
								</li>
							</ul>
						</li>
						<li class="nav-item">
							...
							<ul class="nav-sub">
								 <li class="nav-sub-item">
									<a class="nav-sub-link" href="{{url('view_slider')}}">View Home Slider</a>
								   </li>
								  <li class="nav-sub-item">
									<a class="nav-sub-link" href="{{url('add_slider')}}">Add Home Slider</a>
								</li>
							</ul>
						</li>
				...
				<div class="container-fluid">
				    ...
				    <div class="main-header-right">
						...
						<div class="dropdown main-profile-menu">
							...
							<a class="d-flex" href="#">
								<span class="main-img-user" ><img alt="admin" src="{{asset('public/assets/img/'.session()->get('image'))}}"></span>
							</a>
							 @else 
                               	<a class="d-flex" href="#">
								<span class="main-img-user" ><img alt="admin" src="{{asset('public/assets/img/profile_image.jpg')}}"></span>
							</a>
                                @endif
							<div class="dropdown-menu">
								...
								@if(session()->get('name'))
                                  	<p class="main-notification-text">Hi, {{session()->get('name')}}</p>
                                @else 
                                  <p class="main-notification-text">Administrator</p>
                                @endif
									
								</div>
								<a class="dropdown-item border-top" href="{{url('/admin_profile')}}">
			...
			<div class="mobile-main-header"> 
				<div class="mb-1 navbar navbar-expand-lg  nav nav-item  navbar-nav-right responsive-navbar navbar-dark  ">
						...
						<div class="dropdown main-header-notification">
							...
							<div class="dropdown-menu">
								...
								<div class="main-notification-list">
									<div class="media new">
										<div class="main-img-user online"><img alt="avatar" src="{{asset('public/assets/img/profile.jpg')}}"></div>
										<div class="media-body">
											<p>Congratulate <strong>Olivia James</strong> for New template start</p><span>Oct 15 12:32pm</span>
										</div>
									</div>
									<div class="media">
										<div class="main-img-user"><img alt="avatar" src="{{asset('public/assets/img/profile.jpg')}}"></div>
										<div class="media-body">
					...
					<div class="dropdown main-profile-menu">
							<a class="d-flex" href="#">
								<span class="main-img-user" ><img alt="avatar" src="{{asset('public/assets/img/profile.jpg')}}"></span>
							</a>
							<div class="dropdown-menu">
								<div class="header-navheading">
