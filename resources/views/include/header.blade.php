 ...
 <!--</div>-->
  ...
  <body id=""  class="smallsize" style="overflow-x: hidden;">
    ...
    <nav  class="navbar-default navbar-fixed-top">
         ...
         ><a href="{{url('/')}}">
             <!--<img src="{{URL::asset('public/assets/img/desko_logo.png')}}"  class="block-logo" alt="Image"/>-->
             <img src="{{URL::asset('public/assets/img/desko_black.png')}}"  class="block-logo" alt="Image"/>
             <img src="{{URL::asset('public/assets/img/desko_white.png')}}" class="none-logo" alt="Image"/>
