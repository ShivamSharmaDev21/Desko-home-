  ...
  <body>
	...
	<section class="checkout-page">
	    <div class="container mt-5 mb-5">
	        ...
	        <!--<img src="{{URL::asset('public/assets/img/desko_logo.webp')}}" alt="Image" class="main-logo" />-->
	           <div class="path">
            ...
            <div class="row">
                <div class="col-lg-2">
                    <div class="icon-style">
                        <img src="{{URL::asset('public/assets/img/p-1.png')}}" alt="payment icon">
                    </div>
                </div>
                <div class="col-lg-2">
                    <div class="icon-style">
                        <img src="{{URL::asset('public/assets/img/p-2.png')}}" alt="payment icon">
                    </div>
                </div>
                <div class="col-lg-2">
                    <div class="icon-style">
                        <img src="{{URL::asset('public/assets/img/p-3.png')}}" alt="payment icon">
                    </div>
                </div>
                <div class="col-lg-2">
                    <div class="icon-style">
                        <img src="{{URL::asset('public/assets/img/p-4.png')}}" alt="payment icon">
                    </div>
                </div>
                <div class="col-lg-2">
                    <div class="icon-style">
                        <img src="{{URL::asset('public/assets/img/p-5.png')}}" alt="payment icon">
                    </div>
                </div>
      ...
      <div class="col-md-5" style="    margin-top: -16rem;">
		 ...
		 @if(isset($desk_cart) && count($desk_cart)>0)
			...
			<article class="product">
				...
				<div class="content">
					...
					<span class="qt"><span>Qty</span> : {{$desk->desk_qty}}</span>
		 ...
		 @if(isset($cart_prod) && count($cart_prod)>0)
			...
			<article class="product">
				...
				<div class="content">
					...
					<footer class="pad-top">
					<span class="qt-minus"data_cartId="{{$cart->order_id}}"data_item_type="prod"data_offerPrice="{{$cart->offer_price}}">-</span>
					<span class="qt"><span>Qty</span> : {{$cart->quantity}}</span>
					<span class="qt-plus"data_cartId="{{$cart->order_id}}"data_item_type="prod"data_offerPrice="{{$cart->offer_price}}">+</span>

					<h2 class="full-price"id="{{$cart->order_id}}_{{$cart->offer_price}}">
					   <i class="far fa-rupee-sign"></i>{{($cart->quantity*$cart->offer_price)}}
					</h2>
				
				    </footer>
				 <!--   <a class="remove" href="{{url('remove_cart_checkout/'.'prod'.'/'.$cart->iteam_id)}}">-->
					<!--	<h3><i class="fa fa-trash mb-1 text-danger"></i></h3>-->
					<!--</a>-->
				</div>
			</article>
		...
		<div class="clearfix" id="cart-id">
			...
			<div class="left mt-3 w-100">
				<h2 class="subtotal">Subtotal: <span style="float:right"><i class="far fa-rupee-sign"></i><span id="check-out-1" class="sub_1"> {{$sub_total}}</span></span></h2>
    			@if( isset($order_details->installation) && $order_details->installation==1 ) 
