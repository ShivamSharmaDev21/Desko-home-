        ...
        <div class="container">
          <div class="">
            <div class="row justify-content-center ht100">
                <!--<a href="{{url('/')}}" type="button" class="btn_back"><i class="fal fa-angle-left my-back"></i><span class="span-text"> Back</span></a>-->
                <a href="{{url('custom')}}" data-bs-toggle="modal" data-bs-target="#smartFeature" type="button" class="btn_back"><i class="fal fa-angle-left my-back" ></i><span class="span-text"> Back</span></a>
               
                <form method="post" action="{{url('desk-add-to-cart')}}"id="myForm">
                @csrf 
              ...
              <div class="col-lg-8 "id="screenshot">
                ...
                <div class="" id="calculator">
                  ...
                  <div class="smart_slider"> 
                   @if(isset($smart_features) && isset($smart_feature_ids) && count($smart_features)>0)
                    @foreach($smart_features as $s_f)
                   <?php if (in_array($s_f->id, $smart_feature_ids)) { ?>
                    <div>
                      <a href="#" class="smart_title "  id ="{{$s_f->jquery_selector}}">
                        <div class="inputbox">
                           <label class="pricesmart">
                           <input type="checkbox" class="{{$s_f->jquery_selector}}" name="addprice[]"  store="checkbox{{$s_f->id}}"data_smart_price="{{$s_f->price}}" value="{{$s_f->id}}" checked>
                           <span><img src="{{asset('admin/public/smart_feature_image/'.$s_f->image)}}"> 
                            <p>{{$s_f->feature_name}}</p>
                           </span>
                        </label>
                      </div>
                       </a>
               ...
               <div class="top_slider">
                   <img src="{{asset('admin/public/capture_desk_image/'.$lead_image->image)}}" alt="table image" >
               </div>
              </div>
              <input type="hidden" name="total_desk_price" value="{{$total_desk_price}}">
                 <input type="hidden" name="order_type" id="order_type" value="add_card">
                 <input type="hidden" name="top_gall_id" value="{{$top_gall_id}}">
                 <input type="hidden" name="bottom_gall_id" value="{{$bottom_gall_id}}">
                ...
                <div class="col-lg-4 pricecontent">
                    <h2 class="price-99"><span style ="font-size :28px"><s>&#8377;{{ number_format( $fakePrice , 0, '.', ',' ) }}</s></span></h2>
                    <h1><i class="far fa-rupee-sign" style="font-size : 20px"></i><input class="price_total inputprice" type="text" value="{{  number_format( $totalPrice , 0, '.', ',' )  }}" readonly /></h1>
                    @if(0)
                    ...
                    <table class="table table-bordered  mb-0">
                        ...
                        <tbody>
                          ...
                          <tr class="basic_desk" style="border-width: 0px 0;">
                            <td><img src="{{URL::asset('admin/public/desk_top_image/'.$top_imges_sec[0]->image)}}" height="50px"width="50px"></td>
                            <td><?=$top_imges_sec[0]->top_name.'  ('.$top_imges_sec[0]->colour_name.')  '?></td>
                            <!--<td><i class="far   mr5"></i>Rs. {{ number_format( $top_imges_sec[0]->top_price , 0, '.', ',' )  }}</td>-->
                          </tr>
                           
                          <tr class="basic_desk">
                            <td><img src="{{URL::asset('admin/public/desk_bottom_image/'.$bot_imgest[0]->image)}}" height="50px"width="50px"></td>
                            <td ><?=$bot_imgest[0]->bottom_name.'  ('.$bot_imgest[0]->colour_name.')  '?></td>
                            <!--<td><i class="far   mr5"></i>Rs. {{  number_format( $bot_imgest[0]->bottom_price , 0, '.', ',' )  }}</td>-->
                           ...
                           <?php if (in_array($s_fs->id, $smart_feature_ids)) {  ?>
                            <tr class="basic_desk">
                                 <td> <img src="{{URL::asset('admin/public/smart_feature_image/'.$s_fs->image)}}" height="50px"width="50px"></td>
                                  <td>{{$s_fs->feature_name}}</td>
                                 <!--<td><i class="far   mr5"></i>Rs. {{ number_format( $s_fs->price , 0, '.', ',' ) }}</td>-->
                            </tr>
                            <?php } ?>
                                   @endforeach
                             @endif 
          ...
          <div class="modal-content">
            ...
            <div class="modal-body p-3">
             <div class="row">
                ...
                <div class="d-lfex">
                 <a href="{{url('/custom')}}" class="btn btn-secondary" style="background: #412DB4;margin-right: 13px;">Yes</a>
...
<section class="warranty border-bottom">
                <div class="">
                    ...
                    <div class="row-icons">
                        <div class="icon-div">
                            <img src="{{URL::asset('public/assets/img/icon-1.png')}}" alt="Benefit icon">
                        </div>
                         <div class="icon-div">
                            <img src="{{URL::asset('public/assets/img/icon-2.png')}}" alt="Benefit icon">
                        </div>
                         <div class="icon-div">
                            <img src="{{URL::asset('public/assets/img/icon-3.png')}}" alt="Benefit icon">
                        </div>
                         <div class="icon-div">
                            <img src="{{URL::asset('public/assets/img/icon-4.png')}}" alt="Benefit icon">
                        </div>
                         <div class="icon-div">
                            <img src="{{URL::asset('public/assets/img/icon-5.png')}}" alt="Benefit icon">
                        </div>
                    </div>
                    <!--<div class="card-d">-->
                    <!--    <div class="card-w">-->
