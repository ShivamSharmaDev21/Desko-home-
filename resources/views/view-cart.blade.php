...
<script>
	...
	<div class="container">
		<section id="cart">
			...
			<article class="product">
				...
				<div class="content">
				    ...
				    <a onclick="myfun(this);"class="remove" href="#" data-toggle="modal" data-target="deletems_desk{{$desk->desk_cart_id}}">
				        <h3><i class="fa fa-trash mb-1 text-danger"></i></h3>
				    </a>
				 <!--   <a class="remove" href="{{url('remove_cart/'.'desk'.'/'.$desk->desk_cart_id)}}">-->
					<!--	<h3><i class="fa fa-trash mb-1 text-danger"></i></h3>-->
					<!--</a>-->
				</div>
			</article>
			<!--delete model-->
			 <div id="deletems_desk{{$desk->desk_cart_id}}" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            ...
            <div class="btn-flex">
                 <a href="{{url('remove_cart/'.'desk'.'/'.$desk->desk_cart_id)}}">
		 ...
		 @if(isset($cart_prod) && count($cart_prod)>0)
			...
			<article class="product">
				...
				<div class="content">
				    ...
				    <a onclick="myfun(this);"class="remove" href="#" data-toggle="modal" data-target="deletems_prod{{$cart->id}}">
				        <h3><i class="fa fa-trash mb-1 text-danger"></i></h3>
				    </a>
				 <!--   <a class="remove" href="{{url('remove_cart/'.'prod'.'/'.$cart->id)}}">-->
					<!--	<h3><i class="fa fa-trash mb-1 text-danger"></i></h3>-->
					<!--</a>-->
				</div>
			</article>
			<!--delete model-->
			 <div id="deletems_prod{{$cart->id}}" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h4 class="modal-title" id="myModalLabel">Delete Product</h4>
                                            ...
                                            <div class="modal-footer">
             <div class="btn-flex">
                 <a href="{{url('remove_cart/'.'prod'.'/'.$cart->id)}}">
           <button type="button" class="btn btn-default" id="modbutt">Yes</button></a>
            </div>
            <div class="btn-flex pt-4">
                <button type="button" class="btn btn-info waves-effect hide_model" data-dismiss="modal">Close</button>
		...
		<div class="container clearfix">
			...
			<div class="left">
				<h2 class="subtotal">Subtotal: <i class="far fa-rupee-sign"></i> <span class="tax-p1 sub_1"> {{$sub_total}}</span></h2>
				<!--<h3 class="tax">Taxes (5%): <span class="tax-p"> $8.2</span></h3>-->
				<h3 class="shipping">Shipping: <span class="tax-p">Free</span></h3>
			</div>

			<div class="right">
				<h1 class="total"><span class="total-price">Total: <i class="far fa-rupee-sign"></i></span> <span class="tax-p2 sub_1"> {{$sub_total}}</span></h1>
				<a href="{{url('checkout')}}" class="btn btn-paddd">Checkout</a>
			</div>
