...
#expand{
    ...
    <div id="page">
      ...
      <form method="post" action="{{url('flagship_workstations')}}">
          @csrf
            ...
            <div class="row justify-content-center">
              <div class="col-lg-10">
                <div class="smart_feture text-center mb-5">
                  <h5 class="mb-4">{{(!empty($smart_count))?$smart_count:''}} Smart Features Scroll (Multi-Select)</h5>
                    ...
                    <div>
                      <a href="#" class="smart_title wirles_charge"  id ="wirles_charge">
                        <div class="inputbox">
                           ...
                           <input type="checkbox" name="addprice" id="wirles_price" store="checkbox1" value="{{$s_f->price}}">
              ...
              <div class="top_slider">
                  ...
                  <div class="text1 desk small_desk active_desk" id="content-1">
                      ...
                      <div>
                           ...
                           <div class="colorpicker top_color_first">
                              ...
                              <?php $j=0; ?>
                                 ...
                                 <?php if (in_array($top_clr->colour_id, $colour_arr))
                                  ...
                                  ?>
                            <div class=""style="background-color:{{$colour_val->colour_value}}">
                              <label class="style_color active_input row<?=$i;?>_col<?=$j;?>"  count_data="<?=count($desktops);?>" data-rel="#checkeds" >
                                <input type="radio" class=" pickimg " name="colorradio" row_data="<?=$i?>" c_data="<?=$j?>" count_data="<?=count($desktops);?>" value="{{$colour_val->colour_value}}">
                                <span ></span>
                              </label>
                            </div>
                        ...
                        <div class="manage-slide">
                           ...
                           <div class="imgdesk gray1 "id="<?=$i.'_aj_'.$b?>">
                            <img src="{{URL::asset('admin/public/desk_top_image/'.$top_img->image)}}" >
                          </div>
                         <?php $b++; } } ?>
                          <div class="price">
                          
                          <h3>&nbsp;&nbsp;<i class="fas fa-info-circle mr5 price01" data-bs-toggle="modal" data-bs-target="#myModal"></i>
                            &nbsp;<i class="far fa-rupee-sign"></i><input class="price-title " type="texxt" value="{{$top->top_price}}" readonly /></h3>
                          </div>
                        </div>
                      </div>
                      <?php $i++;?>
                    ...
                    <div class="power_mange_img">
                      <img src="{{asset('public/assets/img/smart/sm2.png')}}">
                    </div>
                    
                    <!-- Footrest image -->
                     <div class="footrest_img">
                      <img src="{{asset('public/assets/img/smart/sm3.png')}}">
                    </div>
