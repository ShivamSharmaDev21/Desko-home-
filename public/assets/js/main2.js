  ...
  var $status = $('.sliderQty');
    ...
    $('.slider-top').each(function() {
      ...
      $(this).addClass('slider-' + numSlick).slick({
        slidesToScroll: 1,
        infinite: false,
        prevArrow: '<button  type="button" class="slick-prev slick-arrow arrow_coustom minus_count"><i class="fal fa-chevron-circle-left"></i></button>',
        nextArrow: '<button  type="button" class="slick-next slick-arrow arrow_coustom plus_count"><i class="fal fa-chevron-circle-right"></i></button>',
        useTransform: true,
        speed: 400,
...
// $('.slider-top').on('slid.bs.slick', function () {
//     var currentSlide = $('.slider-top .slick-current.slick-active').index();
//     sessionStorage.setItem('lastSlide', currentSlide);
// });
// if(sessionStorage.lastSlide){
//     $(".slider-top").slick(sessionStorage.lastSlide*1);
// }
