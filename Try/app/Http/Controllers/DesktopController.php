...
class DesktopController extends Controller
{
         ...
         public function storeDeskTop(Request $request){
            ...
            if($request->hasFile('top_image')){
                   ...
                   $ext= $file->getClientOriginalExtension();
                    $top_image = rand(1000,9999).time().".".$ext;
                       if(!$file->move('public/desk_top_image/', $top_image)){
                       $top_image="";
                ...
                $desktop->top_colour       =implode(',',$request->top_colour);
                $desktop->top_description  =$request->top_description;
                $desktop->top_image        =($top_image)?$top_image:'';
        ...
        public function updateDeskTop(Request $request){
           $request->validate([
                ...
                $hidden_top_image=$request->hidden_top_image;
                 $top_image="";
            if($request->hasFile('top_image')){
