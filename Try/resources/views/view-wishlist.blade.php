...
<script>
    setTimeout(function(){
      ...
      @if((isset($wish_prod) && count($wish_prod)>0))
	...
	<div class="container">
		 ...
		 @if(isset($wish_prod) && count($wish_prod)>0)
			...
			<article class="product">
				...
				<div class="content">
				    ...
				    <a onclick="myfun(this);"class="remove" href="#" data-toggle="modal" data-target="deletems_prod{{$cart->id}}" id="trash">
			...
			<!--delete model-->
             ...
             <div class="btn-flex">
                 <a href="{{url('remove_wish/'.'prod'.'/'.$cart->id)}}">
		...
		<div class="container clearfix">
			...
			<div class="left">
				<h2 class="subtotal"><span class="sub">Subtotal:</span> <i class="far fa-rupee-sign"></i> <span class="tax-p1 sub_1"> {{$sub_total}}</span></h2>
				<!--<h3 class="tax">Taxes (5%): <span class="tax-p"> $8.2</span></h3>-->
				<h3 class="shipping">Shipping: <span class="tax-p">Free</span></h3>
			</div>

			<div class="right">
				<h1 class="total"><span class="total-price"><span class="sub">Total:</span> <i class="far fa-rupee-sign"></i></span> <span class="tax-p2 sub_1"> {{$sub_total}}</span></h1>
				<a href="{{url('wish-to-cart')}}" class="btn btn-paddd">Add To Cart</a>
			</div>
