                  ...
                  <div class="thankyou-wrapper">
                      <h1>THANK YOU </h1>
                            ...
                            <div class="col-md-6">
                               <div class="product-detail">
                                   <div class="" >
                                       ...
                                       <span class="qty-m">Qty:{{$order_qty->quantity}}</span>
                                   </div>
                                   <div class="order-id">
                                   ...
                                   <div class="row">
                                       ...
                                       <div class="col-md-6 w-50">
                                           <span class="px-3">&#8377;{{$order->sub_total}}</span><br>
                                           <span class="px-3">Free</span><br>
                                           <span class="px-3">{{$order->installation==1?"Yes":"No"}}</span>
                                        </div>
                        ...
                        <div class="download-button">
                            <a  style="background-color: rgba(62,43,119,0.7);border-bottom: 0px;"  href="{{ route('invoice.download', [ $order->order_id ]) }}" target="_blank"  >Download Invoice</a>
                        </div>
