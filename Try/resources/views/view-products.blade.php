                                ...
                                <div class="col mb-30">
                                    <div class="product__items ">
                                        <div class="product__items--thumbnail">
                                            <a class="product__items--link" href="{{url('/Products/'.$product->url)}}">
                                            ...
                                            <!--        <a class="product__items--action__btn" href="{{url('/product-detail/'.$product->prod_id)}}">-->
                                        ...
                                        <div class="product__items--content text-center">
                                            ...
                                            <h3 class="product__items--content__title h4 " style="font-family: Kumbh Sans, sans-serif !important;"><a href="#">{{$product->prod_name}}</a></h3>
                                            <div class="product__items--price">
                                                <h6><span class="current__price"><i class="far fa-rupee-sign mr5"></i>{{ number_format( $product->offer_price , 0, '.', ',' ) }}</span></h6>
                                                <h6><span class="old__price"><i class="far fa-rupee-sign mr5"></i>{{ number_format( $product->mrp_price , 0, '.', ',' ) }}</span></h6>
                                            </div>
                                            <a class="product__items--action__cart--btn primary__btn" href="{{url('/add-product-to-cart/'.$product->prod_id)}}">
