...
<!--<div class="header-fixed-placeholder"></div>-->
    <main>
        ...
        @endif
        <section class="row the-hero danish_eid" style="background-image : url('admin/public/slider_image_home/{{ $slider->image }}');
                    ...
                    <div class="col-lg-6 col5 wow fadeInDown" data-wow-delay="0.3s">
                        ...
                        <!--    class="btnshop buttonshop pad-link">{{ $slider->btn2_caption }}</button>-->
                         <button type="button" id="custom-button-id" onclick="location.href='https://deskohome.com/custom'"
                            class="btnshop buttonshop pad-link" style="margin: auto;">{{ $slider->btn2_caption }}</button>
...
<!--show-cont-->
                ...
                <div class="row justify-content-center dflex">
                    @foreach ($products as $product)
                        <div class="col-md-6 text-center hoverAni frontPageProductDiv">
                            <img src="admin/public/feature_image/{{ $product->feature_image }}" id="product-image" class="wow fadeInDown my-fe"
                                data-wow-delay="0.3s" style="min-height: 389px">
                               
                                <h6 class="price-99"><span><s>&#8377;{{ number_format( $product->mrp_price , 0, '.', ',' ) }}</s></span></h6>
                                <h6><span class="price-del">&#8377;{{  number_format( $product->offer_price , 0, '.', ',' )  }}</span></h6>
                                <a href="{{url('/Products')}}/{{$product->url}}" class="button-link wow fadeInUp" 
        ...
        <section id="partner-with-us partner-section" class="mb50 section alter3-features video-section contact-area video-top pb-0">
           <div class="">
                ...
                <div class="btngroup text-center">
                    ...
                    <a href="{{url('/custom')}}" type="button" class="btnshop ">{{ $video->btn_caption }}</a>
                </div>
        ...
        <!--====== Contact Area Start ======-->
         <section class="row left-right-contents mt-3" style="    margin-top: 3rem;background-image : url('admin/public/feature_image_home/{{ $feature->image }}');
                            ...
                            @foreach ($review as $r)
                                ...
                                <div class="card text-center rounded">
                                    <div class="row align-items-center d-flex">
                                        <div class="col-lg-6">
                                            <div class="box_frame"
                                                style="background-image: url('admin/public/review_image_home/{{ $r->image }}');">
                                                <img src="admin/public/review_image_home/{{ $r->image }}">
                        ...
                        <div class="row justify-content-center d-flex flex-top shad my-bott">
                            ...
                            <div class="col-md-7 p-0">
                                <div class="box-watch wow fadeInUp" data-wow-delay="0.3s">
                                    <img src="admin/public/msg_image_home/{{ $m->image }}">
                                </div>
                            </div>
                        ...
                        <div class="row justify-content-center d-flex align-items-center shad my-bott">
                            ...
                            <div class="col-md-6 p-0">
                                <div class="wow fadeInDown" data-wow-delay="0.3s">
                                    <img src="admin/public/msg_image_home/{{ $m->image }}" class="msg-home">
                                </div>
                            </div>
                        </div>
                    @endif
                            ...
                            <div class="card product-card text-center rounded">
                                ...
                                <div class="product-image">
                                    <img loading="lazy" class="product-thumb mx-auto pt-3"
                                        src="admin/public/feature_image/{{ $product->feature_image }}" alt="">
                                </div>
                                <!-- Card Body -->
                                ...
                                <div class="product-order">
                                    ...
                                    <div class="order-btn d-flex flex-wrap justify-content-center">
                                        <a class="prolend-primary style-two m-2" href="{{url('/Products')}}/{{$product->url}}"  >Shop Now</a>
                                    </div>
                                </div>
                            </div>
                        @endforeach
    ...
    <div class="container text-md-start mt-5">
      ...
      <div class="row mt-3">
        ...
        <div class="col-md-3 col-lg-3 col-xl-3 mx-auto mb-4">
          ...
          <div class="navbar-header mb-5" style="width:100%">
              <div class="navbar-brand footer-nav" ><a href="{{url('/')}}">
                  <img src="{{URL::asset('public/assets/img/desko_logo.webp')}}" alt="Image" style="width: 110px; margin-top: -30px;"/></a></div></div>
        ...
        <div class="col-md-3 col-lg-3 col-xl-2 mx-auto mb-4">
          ...
          <p>
            <a href="{{url('/refund')}}" class="text-reset">Refund</a>
          </p>
