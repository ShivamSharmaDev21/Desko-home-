...
<section class="product__section">
            <div class="container-fluid" style="padding: 0rem 2rem;">
                ...
                <div class="row">
                    	    ...
                    	    <div class="row">
                        	    <div class="column small-11 small-centered">
                        	        <div class="slider slider-single">
                        	            <div><img src="https://deskohome.com/admin/public/feature_image/<?=$product_details->feature_image?>"></div>
                            			<?php if(isset($prod_gal_imgss)){
                            			foreach($prod_gal_imgss as $prod_gal_imgs) { 
                            			?>
                        				    <div><img src="https://deskohome.com/admin/public/gallery_image/<?=$prod_gal_imgs->gallery_image?>"></div>
                        				<?php } } ?>
                        			</div>
                        			...
                        			<div class="slider slider-nav">
                        			    <div><span class="product-gallery--media">
                        				        <img src="https://deskohome.com/admin/public/feature_image/<?=$product_details->feature_image?>"></span>
                        				</div>
                            			<?php if(isset($prod_gal_imgss)){
                            			foreach($prod_gal_imgss as $prod_gal_imgs) { 
                            			?>
                    ...
                    <div class="price__current  price__current--on-sale" >
                        ...
                        <span class="money">
                            <?php  $totalPrice = $product_details->offer_price ; ?>
                            ₹ <?=  number_format( $product_details->offer_price , 0, '.', ',' )  ?>
                        </span>
                        <br>
                        <span> (Inclusive of all taxes)</span>
                        <p></p>
                        <span class="you-save-cust">You Save <span>₹ <?= number_format( round(($product_details->mrp_price-$product_details->offer_price),2), 0, '.', ',' )   ?></span></span>
                    </div>
                    ...
                    <div id="razorpay-affordability-widget"> </div>
                     ...
                     <!--    <p>ADDITIONAL <img src="{{asset('public/assets/img/5_-Unit.png')}}"> DISCOUNT ON CHECKOUT</p> -->
                     <!--          <p> </p>-->
                     <!--   </div>-->
                     <!-- </div>-->
          ...
          <form method="get" action="https://deskohome.com/add-to-cart/<?=$product_id?>" >
              ...
              <h5 style="font-size: 15px;
                margin-bottom: -16px;
                font-weight: 600;
                margin-top: 15px;">Smart Features Included</h5>
                  <div class="product-offer">
                        <div class="feture-img mt-3 mb-4">
                            @if( !empty($product_details->is_customized_image) && 0 )
                              <img src="{{URL::asset('admin/public/feature_image/'.$product_details->is_customized_image)}}" height="50px"width="50px">
                            @else
                                <img src="{{asset('public/assets/img/Smart_Features_Icons.png')}}" >
                            @endif
                        </div>
               
                  <ul>
                    <li><img src="{{asset('public/assets/img/Icons-01.svg')}}"> Free <strong>Shipping</strong></li>
                    <li><img src={{asset('public/assets/img/Icons-02.svg')}}> Extended warranty of <strong>3 years </strong></li>
                    
                    <li class="custom_message mtext" ><img src="{{asset('public/assets/img/Icons-03.svg')}}"> Dispatch Within <strong class="">4-5  Days Pan India</strong></li>
                ...
                <div class="buttongroup">
                    ...
                    @if( !empty($product_details->is_customized) && $product_details->is_customized==1 )
                        <a class="btn btnsm btn-red" id="add_to_cart_button" product_id={{$product_id}} >Add to Cart</a>
                        <a href="{{url('/Products/custom')}}" class="btn btnsm btn-red">Customize Table</a>
                    @else
                        <a class="btn btnsm btn-red" id="add_to_cart_button" product_id={{$product_id}} >Add to Cart</a>
                        <button class="btn btnsm btn-red-outline" type="submit" >  Buy now</button>
                    @endif
                </div>
                </form>
              ...
              <div class="tb-badge-div">
                 <div class="tb-badge" style="width: 65px; display: inline-block; margin: 0px 7px; vertical-align: top;"><img class="tb-svg" src="{{asset('public/assets/img/p0.png')}}" alt="American Express" style="width: 65px; height: 65px;"></div>
                <div class="tb-badge" style="width: 65px; display: inline-block; margin: 0px 7px; vertical-align: top;"><img class="tb-svg" src="{{asset('public/assets/img/p1.png')}}" alt="Mastercard" style="width: 65px; height: 65px;"></div>
                <div class="tb-badge" style="width: 65px; display: inline-block; margin: 0px 7px; vertical-align: top;"><img class="tb-svg" src="{{asset('public/assets/img/p2.png')}}" style="width: 65px; height: 65px;"></div>
                <!--<div class="tb-badge" style="width: 65px; display: inline-block; margin: 0px 7px; vertical-align: top;"><img class="tb-svg" src="{{asset('public/assets/img/p3.png')}}" alt="Paytm" style="width: 65px; height: 65px;"></div>-->
                <div class="tb-badge" style=" display: inline-block; margin: 0px 7px; vertical-align: top;"><img class="tb-svg" src="{{asset('public/assets/img/ssl.webp')}}" alt="RuPay" style=" height: 65px;"></div>
                <!--<div class="tb-badge" style="width: 65px; display: inline-block; margin: 0px 7px; vertical-align: top;"><img class="tb-svg" src="{{asset('public/assets/img/p5.svg')}}" alt="Visa" style="width: 65px; height: 65px;"></div>-->
              </div>
            </div>
              ...
              <div class="custom-field custom-field__product-short-desc custom-field__type--html">
                  <div class="custom-field--value">
                    ...
                    This product will be dispatched within <strong>4-5 business days</strong>
  ...
  <div class="custom-tab">
    ...
    <div class="tab-content" id="myTabContent">
     ...
     <div class="tab-pane fade <?=($i==1)?'show active':''?>" id="protab<?=$i?>" role="tabpanel" aria-labelledby="care-instructions">
          <img src="{{asset('admin/public/gallery_image/')}}/<?=$prodimg->gallery_image?>">
        <!--<div class="row">-->
        ...
        <!--          <div class="icon-wrap">-->
        <!--            <img src="{{asset('public/assets/img/01.2-tablecloth.png')}}">-->
        <!--          </div>-->
        <!--        </div>-->
        <!--      </div>-->
        <!--      <div class="col-sm-10">-->
        ...
        <!--        <div class="element-wrap">-->
        <!--          <div class="icon-wrap">-->
        <!--            <img src="{{asset('public/assets/img/02.1-use_coasters.png')}}">-->
        <!--          </div>-->
        <!--        </div>-->
        <!--      </div>-->
        <!--      <div class="col-sm-10">-->
        ...
        <!--        <div class="element-wrap">-->
        <!--          <div class="icon-wrap">-->
        <!--            <img src="{{asset('public/assets/img/03.2-_avoid_direct_sunlight.png')}}">-->
        <!--          </div>-->
        <!--        </div>-->
        <!--      </div>-->
        <!--      <div class="col-sm-10">-->
        ...
        <!--        <div class="element-wrap">-->
        <!--          <div class="icon-wrap">-->
        <!--            <img src="{{asset('public/assets/img/04.2-avoid_minor_scratches.png')}}">-->
        <!--          </div>-->
        <!--        </div>-->
        <!--      </div>-->
        <!--      <div class="col-sm-10">-->
        ...
        <!--        <div class="element-wrap">-->
        <!--          <div class="icon-wrap">-->
        <!--            <img src="{{asset('public/assets/img/05.1-burning_candles.png')}}">-->
        <!--          </div>-->
        <!--        </div>-->
        <!--      </div>-->
        <!--      <div class="col-sm-10">-->
        ...
        <!--        <div class="element-wrap">-->
        <!--          <div class="icon-wrap">-->
        <!--            <img src="{{asset('public/assets/img/08.1wiping_moisture.png')}}">-->
        <!--          </div>-->
        <!--        </div>-->
        <!--      </div>-->
        <!--      <div class="col-sm-10">-->
        ...
        <!--        <div class="element-wrap">-->
        <!--          <div class="icon-wrap">-->
        <!--            <img src="{{asset('public/assets/img/08.1-wiping_the_moisture.png')}}">-->
        <!--          </div>-->
        <!--        </div>-->
        <!--      </div>-->
        <!--      <div class="col-sm-10">-->
        ...
        <!--        <div class="element-wrap">-->
        <!--          <div class="icon-wrap">-->
        <!--            <img src="{{asset('public/assets/img/Icons_Care.png')}}">-->
        <!--         </div>-->
        <!--        </div>-->
        <!--      </div>-->
        <!--      <div class="col-sm-10">-->
 ...
 <div class="product--container">
  <div class="product-static-content">
    ...
    <div class="row fetur">
      <div class="col">
        <div class="mb-4">
          <img src="{{asset('public/assets/img/fetur1.png')}}">
      ...
      <div class="col">
        <div class="mb-4">
          <img src="{{asset('public/assets/img/fetur2.png')}}">
          <!--<h6>Sustainable</h6>-->
      ...
      <div class="col">
        <div class="mb-4">
          <img src="{{asset('public/assets/img/fetur3.png')}}">
      ...
      <div class="col">
        <div class="mb-4">
          <img src="{{asset('public/assets/img/fetur4.png')}}">
       ...
       <div class="col">
        <div class="mb-4">
          <img src="{{asset('public/assets/img/fetur5.png')}}">
          <!--<h6>Anti-Bacterial Surface</h6>-->
          <!--<p>Atmosphere furniture are protected with antibacterial laminate to prevent spread of diseases</p>-->
          <!--<div class="rte">-->
          <!--  <a href=""></a>-->
 ...
 $('.slider-nav').on('click', '.slick-slide', function(event) {
     ...
     $(document).on('click', '#add_to_cart_button', function () {
         var productId = $(this).attr('product_id');
       	$.ajax({
            url:  "{{ url('add-product-to-cart') }}/" + productId,
            type: 'get',
            data: {
                productId:productId,
                _token: "{{ csrf_token() }}"
   ...
   <script>
        ...
        //  var price = 50000;
        // const key = "JTDeO4JRNxbkAs"; //Replace it with your Test Key ID generated from the Dashboard
        // const amount = price; //in paise
