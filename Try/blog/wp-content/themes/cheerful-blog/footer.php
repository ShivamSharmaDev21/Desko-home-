...
if ( is_singular( 'post' ) ) {
	...
	if ( $query->have_posts() ) :
		$related_title = get_theme_mod( 'cheerful_blog_related_posts_title', __( 'Related Posts', 'cheerful-blog' ) );
		?>
					...
					<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
						<div class="post-item post-grid">
							<div class="post-item-image">
								<a href="<?php the_permalink(); ?>"><?php cheerful_blog_post_thumbnail(); ?></a>
							...
							<div class="post-item-content">
								...
								<ul class="entry-meta">
									...
									<li class="read-time">
										...
										<?php
										echo cheerful_blog_time_interval( get_the_content() );
										echo esc_html__( ' min', 'cheerful-blog' );
										?>
									</li>
									<li class="comment">
...
<?php
$cheerful_blog_search = array( '[the-year]', '[site-link]' );
...
$copyright_text       = get_theme_mod( 'cheerful_blog_copyright_text', $copyright_default );
$copyright_text       = str_replace( $cheerful_blog_search, $replace, $copyright_text );
	...
	<div class="theme-wrapper">
		<div class="bottom-footer-info <?php echo esc_attr( $footer_social_class ); ?>">
			<div class="site-info">
				...
				<?php echo sprintf( esc_html__( 'Theme: %1$s By %2$s.', 'cheerful-blog' ), wp_get_theme()->get( 'Name' ), '<a href="' . wp_get_theme()->get( 'AuthorURI' ) . '">' . wp_get_theme()->get( 'Author' ) . '</a>' ); ?>
			</div><!-- .site-info -->
...
<?php if ( get_theme_mod( 'cheerful_blog_enable_scroll_to_top', true ) === true ) : ?>
