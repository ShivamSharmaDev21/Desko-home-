    ...
    <div class="main-content side-content pt-0">
        <div class="container-fluid">
            <div class="inner-body">
                ...
                <div class="page-header">
                    ...
                    <div class="d-flex">
                        <div class="justify-content-center">
                            ...
                            <a href="{{ url('/view_review_home') }}" class="btn btn-primary my-2 btn-icon-text">
                                Review List
                            </a>
                        </div>
                    </div>
                ...
                <form action="{{ url('update_review_home') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                                        ...
                                        <div class="col-md-12 mb-2">
                                            <div class="form-floating mb-3">
                                                ...
                                                <textarea  class="form-control" rows="3" name="description"
                                                    style="height: 100px;"placeholder="Enter Review description">{{ $review->description }}</textarea>
                                    ...
                                    <div class="card custom-card">
                                        <div class="card-body">
                                            ...
                                            <div class="row row-sm">
                                                ...
                                                <input type="hidden" name="hidden_image"value="{{ $review->image }}"
                                                class="form-control" id="floatingInput" placeholder="Slider image">
                                                <div class="col-md-12 mb-2">
                                                    <div class="form-floating mb-3">
                                                        <input type="text" name="dsg"
                                                            value="{{ $review->designation }}" required
                        ...
                        <div class="col-lg-2">
                            <div class="card custom-card">
                                <div class="card-body">
                                    ...
                                    <a target="_blank" href="{{ url('public/review_image_home/' . $review->image) }}">
                                        <img src="{{ url('public/review_image_home/' . $review->image) }}" alt="Forest"
                                            style="width:150px">
                                    </a>
                                </div>
                            </div>
