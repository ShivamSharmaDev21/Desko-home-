						...
						<div class="page-header">
							...
							<div class="d-flex">
								<div class="justify-content-center">
									...
									<a href="{{url('add_subject')}}" class="btn btn-primary my-2 btn-icon-text">
									 Add Subject
									</a>
								</div>
							</div>
										...
										<div class="table-responsive">
											<table id="exportexample" class="table text-center table-bordered border-t0 key-buttons text-nowrap w-100" >
											 ...
											 @foreach($subjects as $subject)
												...
												<td><img src="{{url('/public/subjects/'.$subject->sub_image)}}" width="50" height="50"></td>
											
												<td><a href="{{url('edit_subject/'.$subject->sub_id)}}" class="btn btn-primary">Edit</a></td>
                <td>
                    <form action="{{url('delete_subject/'.$subject->sub_id)}}" method="POST">
                        @csrf
                        @method('DELETE')
