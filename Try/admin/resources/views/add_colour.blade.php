...
<script>
    setTimeout(function(){
       $('.remove_alert').fadeOut();;
										...
										<form action="{{url('store_colour')}}" method="post" >
										    @csrf
										<div class="row row-sm">
                                          	
											<div class="col-md-4 mb-2">
    										    <div class="form-floating mb-3">
        											 <input type="text" value="{{old('colour_name')}}" class="form-control" id="floatingInput" placeholder="name@example.com" name="colour_name">
