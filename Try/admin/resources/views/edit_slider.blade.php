										...
										<div class="row row-sm">
											...
											<div class="col-md-6 mb-2">
										        <div class="form-floating mb-3">
    											    <input type="text"  name="slider_name" value="{{$slider->name}}" required class="form-control" id="floatingInput" placeholder="Slider name">
    											    <input type="hidden"  name="id" value="{{$slider->id}}" required class="form-control" id="floatingInput" placeholder="Slider name">
											...
											<div class="col-md-6 mb-2">
										        <div class="form-floating mb-3">
											        ...
											        <input type="hidden"  name="hidden_image"value="{{$slider->image}}"  class="form-control" id="floatingInput" placeholder="Slider image">
                                              ...
                                              @enderror
										        ...
										        <div class="form-floating mb-3">
    											    <!--<input type="text"  name="description" value="{{old('description')}}" required class="form-control" id="floatingInput" placeholder="Product description">-->
    										         <textarea name="description" class="form-control" id="editor" rows="3" style="height: 100px;" placeholder="Enter Slider description">{{$slider->description}}</textarea>
