	    ...
	    <div class="container mt-5 mb-5">
         ...
         <div class="col-md-6">
	        <div class="payment-method">
	            ...
	            <h3 style="font-size: 23px; padding: 6px;margin-top: 2rem;">Pay Via</h3>
	            <form action='https://cws.in.net/deskohome/order_success/<?=$order_id?>' >
	                <div class="wrapper">
                 ...
                 <!--<input type="radio" name="select" id="option-3">-->
                   <label for="option-1" class="option option-1">
                     ...
                     <div class="d-flex align-items-center">
                          ...
                          <img src="https://cws.in.net/deskohome/public/assets/img/rozer.png" alt="">
                    </div>
                      <!--<span> -->
                      <!--Online </span>-->
      ...
      <div class="col-md-5" style="    margin-top: -5rem;">
		 ...
		 <?php if(isset($cart_prod) && count($cart_prod)>0): ?>
			...
			<article class="product">
				...
				<div class="content">
					...
					<span class="qt"><?php echo e($cart->quantity); ?></span>
		...
		<div class="clearfix" id="cart-id">
			...
			<div class="left mt-3 w-100">
				...
				<!--<h3 class="tax"> <span id="check-out">$8.2</span></h3>-->
				
				<div style="display: flex; width: 100%;  justify-content: space-between;"	>
				<h3 class="shipping">	<input id='Installation' disabled <?php if(isset($order_details->installation) && $order_details->installation==1) echo 'checked'?> name =''  value='1' style="margin-right: 1px;
                    height: 17px;
                    width: 17px;" type='checkbox' /> Installation</h3>
			
				<?php if(isset($order_details->installation) && $order_details->installation==1){ ?>
				<h3 style="text-align: right;" class="sub_1" id="check-out-installment"><i class="far fa-rupee-sign"></i> 500</h3>
				 <?php } ?>
				 	</div>
				<h3 class="shipping">Shipping: <span id="check-out">Free</span></h3>
		
				<h1 class="total"><span class="my-span">Total:<span style="float:right"> <i class="far fa-rupee-sign"></i> <span id="check-out-2" class="sub_1"><?php if(isset($order_details->installation) && $order_details->installation==1) echo $sub_total = $sub_total+500; else echo $sub_total; ?> </span></span></span></h1>
			</div>
...
<script>
var options = {
    "key": "rzp_test_j4Lkz0TwFFQ4MO", // Enter the Key ID generated from the Dashboard
    ...
    "callback_url": "https://cws.in.net/deskohome/payment/payment.php?order_id=<?=$order_id?>",
    "prefill": {
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/cwsinnim/public_html/deskohome/resources/views/payment-method.blade.php ENDPATH**/ ?>