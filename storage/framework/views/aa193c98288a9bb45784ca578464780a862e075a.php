			...
			<div class="main-sidebar main-sidebar-sticky side-menu">
				...
				<div class="main-sidebar-body">
					<ul class="nav">
						...
						<li class="nav-item">
							<a class="nav-link with-sub" href="#"><span class="shape1"></span><span class="shape2"></span><i class="pe-7s-cash sidemenu-icon"></i><span class="sidemenu-label">Banner</span><i class="angle fe fe-chevron-right"></i></a>
							<ul class="nav-sub">
								 <li class="nav-sub-item">
									<a class="nav-sub-link" href="<?php echo e(url('view_banners')); ?>">View Banner</a>
								   </li>
								  <li class="nav-sub-item">
									<a class="nav-sub-link" href="<?php echo e(url('add_banner')); ?>">Add Banner</a>
								</li>
							</ul>
						</li>
						<li class="nav-item">
...
</html><?php /**PATH /home/cws/public_html/goodwill_academy/resources/views/include/header.blade.php ENDPATH**/ ?>