...
<div class="sec-order-detail mt-5">
    ...
    <div class="h4 text-font-h"><?php echo e(date('d-m-Y',strtotime($order->created_at))); ?></div>
    <div class="pt-1">
        <p>Order #<?php echo e($order->order_id); ?> is currently<b class="text-dark">  <?php if($order->order_status==0): ?>
...
<div class="wrapper bg-white">
    <div class="table-responsive">
        <table class="table table-borderless">
            ...
            <tbody>
                 ...
                 <?php $__currentLoopData = $prod_details; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $prod): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    <th scope="row" class="ft"><?php echo e($prod->prod_name); ?></th>
                    <td ><img src="<?php echo e(URL::asset('admin/public/feature_image/'.$prod->feature_image)); ?>" alt="chair" width="70" height="70"></td>
                    <td style="padding-left:30px"><b><?php echo e($prod->quantity); ?></b></td>
                    <td class="text-right mt-text ft"><b><?php echo e(($prod->quantity*$prod->offer_price)); ?></b></td>
                </tr>
                	<?php $sub_total=$sub_total+($prod->quantity*$prod->offer_price);?>
                 <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                <?php endif; ?>
                 <?php if(isset($desk_details) && count($desk_details)>0): ?>
                 <?php $__currentLoopData = $desk_details; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $desk): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                 <tr>
                    <th scope="row" class="ft">Desk</th>
                    <td ><img src="<?php echo e(URL::asset('admin/public/capture_desk_image/'.$desk->captured_desk_img)); ?>" alt="chair" width="70" height="70"></td>
                    <td style="padding-left:30px"><b><?php echo e($desk->desk_qty); ?></b></td>
                    <td class="text-right mt-text ft"><b><?php echo e(($desk->desk_qty*$desk->desk_price)); ?></b></td>
                </tr>
    ...
    <div class="d-flex justify-content-start align-items-center pl-3 py-3 mb-4 border-bottom" id="pl-3">
        ...
        <div class="ml-auto h5" id="auto"><i class="far fa-rupee-sign"></i> <?php echo e($sub_total); ?> </div>
    </div>
    <div class="row border rounded p-1 my-3">
        ...
        <div class="col-md-6 py-3">
            ...
            <h6 classs="pt-1"><?php echo e($add->fname.' '.$add->lname); ?></h6>
                <p class="text-justify pt-1"><?php echo e($add->address); ?>,<?php echo e($add->city_name); ?>,<?php echo e($add->state_name); ?>,<?php echo e($add->pincode); ?></p>
                <p class="text-justify"><?php echo e($add->country); ?></p>
                <p class="text-justify">+91 <?php echo e($add->mobile); ?></p>
            </div>
        </div>
         <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            <?php endif; ?>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/cws/public_html/deskohome/resources/views/order-detail.blade.php ENDPATH**/ ?>