  ...
  <section class="footer-middle">
        ...
        <div class="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
          ...
          <div class="navbar-header mb-5" style="width:100%">
              <div class="navbar-brand footer-nav" ><a href="<?php echo e(url('/')); ?>">
                  <img src="<?php echo e(URL::asset('public/assets/img/desko_logo.webp')); ?>" alt="Image" style="width: 110px;
    margin-top: -30px;"/></a></div></div>
        ...
        <div class="col-md-3 col-lg-2 col-xl-2 mx-auto mb-4">
          ...
          <p>
            <a href="<?php echo e(url('/refund')); ?>" class="text-reset">Refund & Cancellation Policy</a>
          </p>
          <p>
...
</html><?php /**PATH /home/desko2023/public_html/devvsh/resources/views/include/footer.blade.php ENDPATH**/ ?>