    ...
    setTimeout(function(){
       $('.remove_alert').fadeOut();;
										...
										<div class="row row-sm">
											...
											<div class="col-lg-6">
                                                <select name="bottom_material" onchange="my_fun(this.value)"  class="selectpicker form-control" id="number-multiple" data-container="body" data-live-search="true" title="Select Bottom Material" data-hide-disabled="true" data-actions-box="true" data-virtual-scroll="false">
                                                    <?php $__currentLoopData = $materials; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            											 <option value="<?php echo e($mat->id); ?>"<?php echo($mat->id==$deskbottom->bottom_material)?'selected':''?>><?php echo e($mat->material_name); ?></option>
...
unset($__errorArgs, $__bag); ?>
											...
											<div class="col-lg-6">
                                                <select name="bottom_colour[]" multiple class="selectpicker form-control" id="number-multiple" data-container="body" data-live-search="true" title="Select Top Colour" data-hide-disabled="true" data-actions-box="true" data-virtual-scroll="false">
                                                     <?php $colour_arr=explode(',',$deskbottom->bottom_colour);?>
                                                     <?php $__currentLoopData = $colours; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            											 <option value="<?php echo e($cal->id); ?>"<?php echo(in_array($cal->id,$colour_arr))?'selected':''?>><?php echo e($cal->colour_name); ?></option>
            											 <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                 </select>
                                                <span class="text-danger">* You can add  multiple colour</span>
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <div class="col-md-6 mt-2 mb-2">
										        <div class="form-floating mb-3">
    											    <input type="text"  name="bottom_name" value="<?php echo e($deskbottom->bottom_name); ?>" required class="form-control" id="floatingInput" placeholder="Top name ">
    											    <input type="hidden"  name="bottom_id" value="<?php echo e($deskbottom->bottom_id); ?>" required class="form-control" id="floatingInput" placeholder="Top name ">
...
unset($__errorArgs, $__bag); ?>
											...
											<div class="col-md-6 mt-2 mb-2">
										        <div class="form-floating mb-3">
    											    <input type="number"  name="bottom_price" value="<?php echo e($deskbottom->bottom_price); ?>" readonly id="bottom_price" required class="form-control" id="floatingInput" placeholder="Top price">
...
unset($__errorArgs, $__bag); ?>
											...
											<div class="col-md-6 mb-2">
										        <div class="form-floating mb-3">
											        ...
											        <input type="hidden"  name="hidden_bottom_image"value="<?php echo e($deskbottom->bottom_image); ?>"  class="form-control" id="floatingInput" >
...
unset($__errorArgs, $__bag); ?>
												...
												<div class="col-md-6 mb-2">
										        <img src="<?php echo e(URL::asset('public/desk_bottom_image/'.$deskbottom->bottom_image)); ?>" height="50px"width="50px">
											</div>
											<div class="col-md-12 ">
										        <div class="form-floating mb-3">
...
unset($__errorArgs, $__bag); ?>
										...
										<div class="row row-sm">
											<div class="col-md-6">
												...
												<a href="view_desk_bottom" class="btn ripple btn-outline-danger pd-x-30">Cancel</a>
											</div>
										</div>
										</form>
									</div>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/cws/public_html/deskohome/admin/resources/views/edit_desk_bottom.blade.php ENDPATH**/ ?>