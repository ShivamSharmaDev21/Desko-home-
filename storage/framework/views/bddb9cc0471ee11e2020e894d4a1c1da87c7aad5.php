	...
	<div class="container" id="cart-id">
		...
		<div class="clearfix" id="cart-id">
			...
			<div class="left">
				...
				<input id='Installation' name ='' value='1' style="margin-right: 10px;" type='checkbox' />
				<h3 class="shipping">Installation</h3>
				<h3 style="margin-left: 17rem;display: none;" class="sub_1" id="check-out-installment">500</h3>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/cws/public_html/deskohome/resources/views/checkout.blade.php ENDPATH**/ ?>