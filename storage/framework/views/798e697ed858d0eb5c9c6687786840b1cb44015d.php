											...
											<div class="col-lg-6">
                                                <select name="top_material" onchange="my_fun(this.value)"  class="selectpicker form-control" id="number-multiple" data-container="body" data-live-search="true" title="Select Top Material" data-hide-disabled="true" data-actions-box="true" data-virtual-scroll="false">
                                                    <?php $__currentLoopData = $materials; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            											 <option value="<?php echo e($mat->id); ?>"<?php echo($mat->id==$desktop->top_material)?'selected':''?>><?php echo e($mat->material_name); ?></option>
...
unset($__errorArgs, $__bag); ?>
											...
											<div class="col-lg-6">
                                                <select name="top_colour[]" multiple class="selectpicker form-control" id="number-multiple" data-container="body" data-live-search="true" title="Select Top Colour" data-hide-disabled="true" data-actions-box="true" data-virtual-scroll="false">
                                                     <?php $colour_arr=explode(',',$desktop->top_colour);?>
...
unset($__errorArgs, $__bag); ?>
											...
											<div class="col-md-6 mt-2 mb-2">
										        <div class="form-floating mb-3">
    											    <input type="number"  name="top_price" value="<?php echo e($desktop->top_price); ?>" readonly id="top_price" required class="form-control" id="floatingInput" placeholder="Top price">
...
unset($__errorArgs, $__bag); ?>
											...
											<div class="col-md-6 mb-2">
										        <div class="form-floating mb-3">
											        ...
											        <input type="hidden"  name="hidden_top_image"value="<?php echo e($desktop->top_image); ?>"  class="form-control" id="floatingInput" >
...
unset($__errorArgs, $__bag); ?>
												...
												<div class="col-md-6 mb-2">
										        <img src="<?php echo e(URL::asset('public/desk_top_image/'.$desktop->top_image)); ?>" height="50px"width="50px">
											</div>
											<div class="col-md-12 ">
										        <div class="form-floating mb-3">
...
unset($__errorArgs, $__bag); ?>
										...
										<div class="row row-sm">
											<div class="col-md-6">
												...
												<a href="view_desk_top" class="btn ripple btn-outline-danger pd-x-30">Cancel</a>
											</div>
										</div>
										</form>
									</div>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/cws/public_html/deskohome/admin/resources/views/edit_desk_top.blade.php ENDPATH**/ ?>