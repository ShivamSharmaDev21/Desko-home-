										...
										<div class="table-responsive">
											<table id="exportexample" class="table text-center table-bordered border-t0 key-buttons text-nowrap w-100" >
											 ...
											 <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $users): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
												...
												<td><a href="<?php echo e(url('edit_user/'.$users->user_id.'/'.$state)); ?>" class="btn btn-primary">Edit</a></td>
                <td>
                    <form action="<?php echo e(url('delete_user/'.$users->user_id.'/'.$state)); ?>" method="POST">
                        <?php echo csrf_field(); ?>
