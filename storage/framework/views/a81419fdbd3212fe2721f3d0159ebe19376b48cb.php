				...
				<div class="main-sidebar-body">
					<ul class="nav">
						...
						<li class="nav-item">
							...
							<ul class="nav-sub">
								 <li class="nav-sub-item">
									<a class="nav-sub-link" href="<?php echo e(url('view_users/all')); ?>"> All Users</a>
								   </li>
								  <li class="nav-sub-item">
									<a class="nav-sub-link" href="<?php echo e(url('view_users/active')); ?>">Active Users</a>
								</li>
								<li class="nav-sub-item">
									<a class="nav-sub-link" href="<?php echo e(url('view_users/in-active')); ?>">In-active Users</a>
								</li>
							</ul>
						</li>
						<li class="nav-item">
...
</html><?php /**PATH /home/cws/public_html/deskohome/admin/resources/views/include/header.blade.php ENDPATH**/ ?>