						...
						<h2 class="main-content-title tx-24 mg-b-5">Edit User </h2>
							...
							<div class="d-flex">
								<div class="justify-content-center"> 
									...
									<a href="<?php echo e(url('/view_users/'.$state)); ?>" class="btn btn-primary my-2 btn-icon-text">
									   User List
									</a>
								</div>
							</div>
...
<script>
    setTimeout(function(){
       $('.remove_alert').fadeOut();;
										...
										<form action="<?php echo e(url('update_user/'.$user->user_id.'/'.$state)); ?>" method="POST" >
...
unset($__errorArgs, $__bag); ?>-->
										...
										<div class="row row-sm">
											<div class="col-md-6">
												...
												<a href="<?php echo e(url('/view_users/'.$state)); ?>"  type="reset" class="btn ripple btn-outline-danger pd-x-30">Cancel</a>
											</div>
										</div>
										</form>
									</div>
