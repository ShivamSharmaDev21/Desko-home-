          ...
          <div class="modal-body">
    	    <div class="form-modal">
              <div id="login-form">
                ...
                <!--<br>-->
                <labal>Mobile</labal>
                <input type="number"id="usermob" name="mobile"onfocusout="check_Mobile(this.value)" placeholder="Enter mobile number" <?php echo (session('user_id'))?'':'required'?>/>
                <br>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\deskohome\resources\views/index.blade.php ENDPATH**/ ?>