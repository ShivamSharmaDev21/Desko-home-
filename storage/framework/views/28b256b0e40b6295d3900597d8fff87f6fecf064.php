										...
										<div class="table-responsive">
											...
											<?php if(isset($deskbottoms) && count($deskbottoms)>0): ?>
											 <?php $__currentLoopData = $deskbottoms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bot): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
												...
												<td><img src="<?php echo e(URL::asset('public/desk_bottom_image/'.$bot->bottom_image)); ?>" height="50px"width="50px"></td>
												<td><?php echo e($bot->material_name); ?></td>
												<td><?php echo e($bot->bottom_price); ?></td>
												<td>
    												<?php 
    												    $bottom_colour_arr=explode(',',$bot->bottom_colour);
    												    foreach($colours as $cal){
    												    if(in_array($cal->id, $bottom_colour_arr)){echo $cal->colour_name.' ';}
    												    }
    												?>
												</td>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/cws/public_html/deskohome/admin/resources/views/view_desk_bottoms.blade.php ENDPATH**/ ?>