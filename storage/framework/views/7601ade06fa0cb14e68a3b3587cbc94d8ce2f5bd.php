...
<script>
    setTimeout(function(){
       $('.remove_alert').fadeOut();;
										...
										<form action="<?php echo e(url('store_category')); ?>" method="post" >
										    <?php echo csrf_field(); ?>
										<div class="row row-sm">
                                          	
											<div class="col-md-4 mb-2">
    										    <div class="form-floating mb-3">
        											 <input type="text" name="category_name" value="<?php echo e(old('category_name')); ?>" required class="form-control" id="floatingInput" placeholder="Category name" >
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/cws/public_html/deskohome/admin/resources/views/add_category.blade.php ENDPATH**/ ?>