  ...
  <section class="footer-middle">
    ...
    margin-top: -30px;"/></a></div></div>
        ...
        <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
          ...
          <p><i class="fas fa-phone me-3 f-circle"></i>  <a href="tel:+917383197038"> +91 7383197038</a></p>
        </div>
        <!-- Grid column -->
      </div>
      <!-- Grid row -->
...
<!-- Footer -->
  ...
  <!--<script src="<?php echo e(asset('public/assets/js/main2.js')); ?>"></script>-->
 <script>
$(document).ready(function(){
    ...
    $("#txt_search").keyup(function(){
        ...
        if(search != ""){
            $.ajax({
                url: "<?php echo e(url('live-search-product')); ?>",
                type: 'post',
                data: {
                    prod_name:search,
...
</html><?php /**PATH /home/desko2023/public_html/development/resources/views/include/footer.blade.php ENDPATH**/ ?>