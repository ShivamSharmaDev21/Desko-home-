	           ...
	           <div class="row row-sm"> 
							<div class="col-lg-12 col-md-12">
								<div class="card custom-card">
									<div class="card-body">
										<div>
											<h6 class="main-content-label mb-1"> Edit Banner </h6>
...
<div>
 <?php if(Session::get('success')): ?>
    ...
    <?php endif; ?>
										...
										<form action="<?php echo e(url('/update_banner/'.$banner->id)); ?>" method="POST" enctype="multipart/form-data" >
										...
										<div class="row row-sm">
										    ...
										    <div class="form-floating mb-3">
											 <input type="text" value="<?php echo e($banner->name); ?>" class="form-control" id="floatingInput" placeholder="name@example.com" name="banner_name">
...
unset($__errorArgs, $__bag); ?>
											...
											<div class="col-md-4 mb-2">
										        <div class="form-floating mb-3">
											        <input type="file" value="<?php echo e($banner->img); ?>" class="form-control" id="floatingInput" placeholder="name@example.com" name="banner_image">
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/cws/public_html/goodwill_academy/resources/views/edit_banner.blade.php ENDPATH**/ ?>