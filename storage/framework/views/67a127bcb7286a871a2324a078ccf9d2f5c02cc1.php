		 ...
		 <?php if(isset($desk_cart) && count($desk_cart)>0): ?>
			...
			<article class="product">
				...
				<div class="content">
                    ...
                    ?>
					   <i class="far fa-rupee-sign"></i><?php echo e($sub_total1); ?>
		...
		<div class="clearfix" id="cart-id">
            ...
            <?php endif; ?>
				...
				<div class="left w-100">
                   ...
                   ?>
				<h2 class="subtotal">Subtotal: <span style="float:right"><i class="far fa-rupee-sign"></i><span id="check-out-1"class="sub_1"> <?php echo e(number_format( $sub_total , 0, '.', ',' )); ?></span></span></h2>
				...
				<h1 class="total"><span class="my-span">Total:<span style="float:right"> <i class="far fa-rupee-sign"></i> <span id="check-out-2"class="sub_1"> <?php echo e(number_format( $sub_total , 0, '.', ',' )); ?></span></span></h1>
			</div>
 ...
 <?php if(Session::get('success')): ?>
    ...
    <a href="<?php echo e(url('/')); ?>" > <img src="<?php echo e(URL::asset('public/assets/img/desko_logo.webp')); ?>" alt="Image" class="main-logo" />  </a>
      ...
      <h4 class="mb-3">Shipping Address</h4>
           ...
           <form onsubmit="return validatePhoneNumber()" id="basic-form" method="post" action="<?php echo e(url('payment-method')); ?>"  class="needs-validation">
          <?php echo csrf_field(); ?>
        <div class="row">
          <div class="col-md-6 mb-3">
            ...
            <input type="hidden" name="sub_total" value=" <?php echo e((isset($sub_total))?$sub_total:'0'); ?>" class="form-control" id="" placeholder="" >
         ...
         <div class="row">
          ...
          <div class="col-md-6 mb-3">
            <label for="mobile">Mobile <span class="required">*</span></label>
                ...
                ?>
            <input type="number"name="mobile" value="<?php echo e((isset( $phoneNumber))?  $phoneNumber :''); ?>"   inputmode="numeric" maxlength="10" minlength="10" class="form-control" id="mobile" placeholder="Mobile Number *" required>
            <div class="invalid-feedback">
            ...
            <div class="row align-items-center">
                 <div class="col-lg-3">
                    <div class="icon-style">
                        <img src="<?php echo e(URL::asset('public/assets/img/ssl.webp')); ?>" alt="" width="150px">
                    </div>
                </div>
		 ...
		 <script>
            ...
            $('#apply_coupon_code').click(function () {
                var coupon_code_name = $('#coupon_code_name').val();
               	$.ajax({
                    url: "<?php echo e(url('coupon_code_name_using')); ?>",
                    type: 'get',
                    data: {
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/desko2023/public_html/devvsh/resources/views/checkout.blade.php ENDPATH**/ ?>