                ...
                <div class="tab_content">
                    <div id="chair" class="tab_pane active show">
                        <div class="product__section--inner">
                            <div class="row row-cols-xl-4 row-cols-lg-4 row-cols-md-3 row-cols-2 mb--n30" style="display: flex; align-items: center; justify-content: center;">
                                <?php if(isset($products) && count($products)>0): ?>
                                <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="col mb-30">
                                    <div class="product__items ">
                                        <div class="product__items--thumbnail">
                                            <a class="product__items--link" href="<?php echo e(url('/Products/'.$product->url)); ?>">
                                        ...
                                        <div class="product__items--content text-center">
                                            ...
                                            <h3 class="product__items--content__title h4 " style="font-family: Kumbh Sans, sans-serif !important;"><a href="#"><?php echo e($product->prod_name); ?></a></h3>
                                            <div class="product__items--price">
                                                <h6><span class="current__price"><i class="far fa-rupee-sign mr5"></i><?php echo e(number_format( $product->offer_price , 0, '.', ',' )); ?></span></h6>
                                                <h6><span class="old__price"><i class="far fa-rupee-sign mr5"></i><?php echo e(number_format( $product->mrp_price , 0, '.', ',' )); ?></span></h6>
                                            </div>
                                            <a class="product__items--action__cart--btn primary__btn" href="<?php echo e(url('/add-product-to-cart/'.$product->prod_id)); ?>">
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/desko2023/public_html/devvsh/resources/views/view-products.blade.php ENDPATH**/ ?>