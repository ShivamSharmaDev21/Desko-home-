...
<!--<div class="header-fixed-placeholder"></div>-->
    <main>
        ...
        <section class="row the-hero" style="background-image : url('admin/public/slider_image_home/<?php echo e($slider->image); ?>');
        ...
        <section class="row the-product pb-0" id="product">
            <div class="container">
                ...
                <div class="row apple-watch-note-feature text-center">
                    ...
                    <img src="admin/public/frontend/assets/img/Plus-Sign.png" alt="" width="80%">
<!--show-cont-->
                ...
                <div class="row justify-content-center dflex">
                    <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="col-md-6 text-center hoverAni">
                            <img src="admin/public/feature_image/<?php echo e($product->feature_image); ?>" class="wow fadeInDown my-fe"
                                data-wow-delay="0.3s">
                               
                                <h6 class="price-99"><span><s>&#8377;<?php echo e($product->mrp_price); ?></s></span> <span class="price-del">&#8377;<?php echo e($product->offer_price); ?></span></h6>
                            <a href="https://devvsh.deskohome.com/development/product-detail/<?=$product->prod_id?>" class="button-link wow fadeInUp" 
                ...
                <div class="row justify-content-center d-flex">
                    <div class="col-12 col-md-12 ">
                        ...
                        <div class="company-logo">
                            <img src="admin/public/frontend/assets/img/Company-Logos.png" alt="" width="1100px"/>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="banner__items position__relative">
                                <a class="banner__items--thumbnail" href="#">
                                    <img class="banner__items--thumbnail__img wow fadeInDown" data-wow-delay="0.3s"
                                        src="admin/public/frontend/assets/img/Desko-productivity.jpg" alt="banner-img"
                            ...
                            <div class="card product-card text-center rounded">
                                ...
                                <div class="product-order">
                                    ...
                                    <div class="order-btn d-flex flex-wrap justify-content-center">
                                        <a class="prolend-primary style-two m-2" href="https://devvsh.deskohome.com/development/product-detail/<?=$product->prod_id?>">Shop Now</a>
                                    </div>
                                </div>
                            </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="container">
                ...
                <div class="row wow fadeInUp" data-wow-delay="0.5s">
                    <div class="col-12 ">
                        ...
                        <!--</table>-->
                        <div class="table-img">
                            <img src="admin/public/frontend/assets/img/DeskoComparative.png" width="1180" >
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row justify-content-center d-flex">
                    <div class="col-12 col-md-10">
                        ...
                        <div class="contact-box text-center">
                            <!-- Contact Form -->
                           <form id="contact-form" method="POST" action="https://devvsh.deskohome.com/development/admin/contact-us-form">
    ...
    margin-top: -30px;"/></a></div></div>
        ...
        <div class="col-md-3 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
         ...
         <div class="flex-items">
           ...
           <p>
          Ground Floor, KH No - 9/20,
          Laxmi Vihar, Najafgarh, New Delhi,
         ...
         <div class="flex-items">
              <p><i class="fas fa-phone me-3 f-circle"></i> </p> <a href="tel:+917383197038"> +91 7383197038</a>
         </div>
...
<i class="fab fa-whatsapp my-float"></i>
  ...
  <!-- Copyright -->
        ...
        <!--            </ul>-->
        <!--            <p>Copyright © 2023. METADESK PRIVATE LIMITED.-->
    ...
    <div class="float">
        <a href="https://api.whatsapp.com/message/JKIJWZUNVBQBE1?autoload=1&app_absent=0" class=" d-flex" target="_blank"><i class="fab fa-whatsapp my-float
"></i><div class="chat"><h5>Chat Us</h5></div>
</a>
    </div>
...
<?php /**PATH /home/desko2023/public_html/development/resources/views/index_home.blade.php ENDPATH**/ ?>