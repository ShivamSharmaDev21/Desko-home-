      ...
      <div class="m_mobile" style="width: 100%;">
         <div class="row justify-content-center mb-5" >
                  <div class="col-lg-12" id="title-color">
                      <!--<div class="img-banner"><img src="<?php echo e(URL::asset('public/assets/img/back-banner-mg.jpg')); ?>" style="height:100px;width:100%"/>-->
        ...
        <div class="container">
              ...
              <div class="col-lg-10">
                ...
                <div class="smart_feture text-center mb-5">
                  ...
                  <div class="smart_slider">  
                    ...
                    <div>
                      <a href="#" class="smart_title <?php echo e($s_f->jquery_selector); ?>"  id ="<?php echo e($s_f->jquery_selector); ?>">
                        <div class="inputbox">
                           <label class="pricesmart">
                           <input type="checkbox" onchange='test_function(this)' name="addprice[]"  store = "checkbox<?php echo e($s_f->id); ?>" data_smart_price = "<?php echo e($s_f->price); ?>" value="<?php echo e($s_f->id); ?>">
                           <span ><img src="<?php echo e(asset('admin/public/smart_feature_icon/'.$s_f->icon)); ?>"> 
         ...
         <hr>
                      ...
                      <div>
                           ...
                           <div class="colorpicker top_color_first">
                              ...
                              <?php $j=0; ?>
                                 ...
                                 <?php if (in_array($top_clr->colour_id, $colour_arr))
                                  ...
                                  ?>
                            <div class="btn-red"style="background-color:<?php echo e($colour_val->colour_value); ?>">
                        ...
                        <div class="manage-slide">
                         ...
                         <?php $b++; } } ?>
                          ...
                          <h3> <i class="fa fa-plus" style="font-size:36px" data-bs-toggle="modal" data-bs-target="#modelfor_plus"></i>
                              ...
                              <?php $j=0; ?>
                                 ...
                                 <?php if (in_array($bot_clr->colour_id, $colour_arr))
                                  { $colour_value= App\Models\Colour::where('id',$bot_clr->colour_id)->first();
                                    //echo "<pre>"; echo($colour_val);die;
                                  ?>
                            <div class="btn-red"style="background-color:<?php echo e($colour_value->colour_value); ?>">
              ...
              <?php if(session('user_id') || session('mobile')): ?>
...
<section class="pt-4 pb-3">
  ...
  <div class="carousel-inner">
    ...
    <div class="carousel-item <?php echo ($i==1)?'active':''?>">
      <img src="<?php echo e(URL::asset('admin/public/slider_image/'.$s->image)); ?>" alt="Los Angeles" class="d-block" style="width:100%">
    </div>
    <?php $i++;?>
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    <?php endif; ?>
    ...
    console.log('test function created by shubham');
         $.ajax({
            //  url: "https://cws.in.net/deskohome/desk-add-leads", 
             url: "<?php echo e(url('desk-add-leads')); ?>", 
                type: 'post',
                data: { 
                _token: "<?php echo e(csrf_token()); ?>",
                image: image,
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/cws/public_html/deskohome/resources/views/index.blade.php ENDPATH**/ ?>