										...
										<div class="table-responsive">
											<table id="exportexample" class="table text-center table-bordered border-t0 key-buttons text-nowrap w-100" >
											 ...
											 <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
												...
												<td><img src="<?php echo e(URL::asset('adminn/public/feature_image/'.$product->feature_image)); ?>" height="50px"width="50px"></td>
												<td><?php echo e($product->offer_price); ?></td>
												<td><?php echo e($product->mrp_price); ?></td>
											    <td><select onchange="change_status(<?php echo $product->prod_id?>,this.value)"><option value="1"<?php echo($product->status==1)?'selected':''?>>Active</option><option value="0"<?php echo($product->status==0)?'selected':''?>>In-active</option></select></td>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/cws/public_html/deskohome/admin/resources/views/view_products.blade.php ENDPATH**/ ?>