...
<script>
    setTimeout(function(){
       $('.remove_alert').fadeOut();;
										...
										<form action="<?php echo e(url('store_desk_bottom')); ?>" method="post" enctype="multipart/form-data" >
										    <?php echo csrf_field(); ?>
										<div class="row row-sm">
											...
											<div class="col-lg-6">
                                                ...
                                                <!--<label for="floatingInput">Top Material</label>-->
                                                 <?php $__errorArgs = ['bottom_material'];
...
unset($__errorArgs, $__bag); ?>
											...
											<div class="col-lg-6">
                                                <select name="bottom_colour[]" multiple class="selectpicker form-control" id="number-multiple" data-container="body" data-live-search="true" title="Select Bottom Colour" data-hide-disabled="true" data-actions-box="true" data-virtual-scroll="false">
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <div class="col-md-6 mt-2 mb-2">
										        <div class="form-floating mb-3">
    											    <input type="text"  name="bottom_name" value="<?php echo e(old('bottom_name')); ?>" required class="form-control" id="floatingInput" placeholder="Bottom name">
    										        <label for="floatingInput">Bottom Name</label>
    										         <?php $__errorArgs = ['bottom_name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
											...
											<div class="col-md-6 mt-2 mb-2">
										        <div class="form-floating mb-3">
    											    <input type="number"  name="bottom_price" value="<?php echo e(old('bottom_price')); ?>" readonly id="bottom_price" required class="form-control" id="floatingInput" placeholder="Bottom price">
...
unset($__errorArgs, $__bag); ?>
											...
											<div class="col-md-12 ">
										        <div class="form-floating mb-3">
    										         ...
    										         <textarea name="bottom_description" class="form-control" id="editor" rows="3" style="height: 100px;" placeholder="Enter  Description"><?php echo e(old('bottom_description')); ?></textarea>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/cws/public_html/deskohome/admin/resources/views/add_desk_bottom.blade.php ENDPATH**/ ?>