		...
		<div class="inner-body">
             <!-- Page Header -->
				<div class="page-header">
					<div>
						<h2 class="main-content-title tx-24 mg-b-5">Add Subject </h2>
							<ol class="breadcrumb">
							...
							<div class="d-flex">
								<div class="justify-content-center"> 
									...
									<a href="<?php echo e(url('/view_subjects')); ?>" class="btn btn-primary my-2 btn-icon-text">
									   Subject List
									</a>
								</div>
							</div>
	           ...
	           <div class="row row-sm"> 
							<div class="col-lg-12 col-md-12">
								<div class="card custom-card">
									<div class="card-body">
										<div>
											<h6 class="main-content-label mb-1"> Add Subject </h6>
...
<div>
 <?php if(Session::get('success')): ?>
    ...
    <?php endif; ?>
										...
										<form action="<?php echo e(url('store_subject')); ?>" method="post" enctype="multipart/form-data" >
										    <?php echo csrf_field(); ?>
										<div class="row row-sm">
                                          	
											<div class="col-md-4 mb-2">
										    <div class="form-floating mb-3">
											 <input type="text" value="<?php echo e(old('subject_name')); ?>" class="form-control" id="floatingInput" placeholder="name@example.com" name="subject_name">
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/cws/public_html/assemble_desk/admin/resources/views/add_subject.blade.php ENDPATH**/ ?>