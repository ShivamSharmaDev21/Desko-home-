...
<section class="product__section">
                    	    ...
                    	    <div class="row">
                        	    <div class="column small-11 small-centered">
                        	        <div class="slider slider-single">
                        	            <div><img src="https://devvsh.deskohome.com/admin/public/feature_image/<?=$product_details->feature_image?>"></div>
                            			<?php if(isset($prod_gal_imgss)){
                            			foreach($prod_gal_imgss as $prod_gal_imgs) { 
                            			?>
                        				    <div><img src="https://devvsh.deskohome.com/admin/public/gallery_image/<?=$prod_gal_imgs->gallery_image?>"></div>
                        				<?php } } ?>
                        			</div>
                        			...
                        			<div class="slider slider-nav">
                        			    <div><span class="product-gallery--media">
                        				        <img src="https://devvsh.deskohome.com/admin/public/feature_image/<?=$product_details->feature_image?>"></span>
                        				</div>
                            			<?php if(isset($prod_gal_imgss)){
                            			foreach($prod_gal_imgss as $prod_gal_imgs) { 
                            			?>
                        				<div>
                        				    <span class="product-gallery--media">
                        				        <img src="https://devvsh.deskohome.com/admin/public/gallery_image/<?=$prod_gal_imgs->gallery_image?>">
                        				    </span>
                        				</div>
                        				<?php } } ?>
                        			</div>
          ...
          <form method="get" action="https://devvsh.deskohome.com/add-to-cart/<?=$product_id?>" >
              ...
              <h5 style="font-size: 15px;
                ...
                margin-top: 15px;">Smart Features Included</h5>
                  <div class="product-offer">
                        <div class="feture-img mt-3 mb-4">
                            <?php if( !empty($product_details->is_customized_image) && 0 ): ?>
                              <img src="<?php echo e(URL::asset('admin/public/feature_image/'.$product_details->is_customized_image)); ?>" height="50px"width="50px">
                            <?php else: ?>
                  ...
                  <ul>
                    ...
                    <li><img src=<?php echo e(asset('public/assets/img/Icons-02.svg')); ?>> Extended warranty of <strong>3 years </strong></li>
                    
                    <li class="custom_message mtext" ><img src="<?php echo e(asset('public/assets/img/Icons-03.svg')); ?>"> Dispatch Within <strong class="">4-5  Days Pan India</strong></li>
                ...
                <div class="buttongroup">
                    ...
                    <?php if( !empty($product_details->is_customized) && $product_details->is_customized==1 ): ?>
                        <a class="btn btnsm btn-red" id="add_to_cart_button" product_id=<?php echo e($product_id); ?> >Add to Cart</a>
                        <a href="<?php echo e(url('/Products/custom')); ?>" class="btn btnsm btn-red">Customize Table</a>
                    <?php else: ?>
                        <a class="btn btnsm btn-red" id="add_to_cart_button" product_id=<?php echo e($product_id); ?> >Add to Cart</a>
              ...
              <div class="tb-badge-div">
                ...
                <div class="tb-badge" style=" display: inline-block; margin: 0px 7px; vertical-align: top;"><img class="tb-svg" src="<?php echo e(asset('public/assets/img/ssl.webp')); ?>" alt="RuPay" style=" height: 65px;"></div>
 ...
 $('.slider-nav').on('click', '.slick-slide', function(event) {
     ...
     $(document).on('click', '#add_to_cart_button', function () {
         var productId = $(this).attr('product_id');
       	$.ajax({
            url:  "<?php echo e(url('add-product-to-cart')); ?>/" + productId,
            type: 'get',
            data: {
                productId:productId,
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/desko2023/public_html/devvsh/resources/views/product-detail.blade.php ENDPATH**/ ?>