	    ...
	    <div class="container mt-5 mb-5">
         ...
         <div class="col-md-6">
	        <div class="payment-method">
	            ...
	            <form action='https://devvsh.deskohome.com/order_success/<?=$order_id?>' >
	                <div class="wrapper">
                 ...
                 <!--<input type="radio" name="select" id="option-3">-->
                   <label for="option-1" class="option option-1 p-0" style=" pointer-events: none;">
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <img class="p-0"src="https://devvsh.deskohome.com/public/assets/img/payment1.1.png" style="width:50% "> 
                        <img class="p-0"src="https://devvsh.deskohome.com/public/assets/img/payment2.jpeg" style="width:49%">                        
                        ...
                        <!--      <img src="https://devvsh.deskohome.com/public/assets/img/payment1.jpeg" style="width:30%">-->
                              <!--<div class="text">Caption Text</div>-->
                        <!--    </div>-->
                            
                        <!--    <div class="mySlides fade">-->
                        <!--      <div class="numbertext">2 / 3</div>-->
                        <!--      <img src="https://devvsh.deskohome.com/public/assets/img/payment2.jpeg" style="width:30%">-->
                              <!--<div class="text">Caption Two</div>-->
                        <!--    </div>-->
                            
                        <!--    <div class="mySlides fade">-->
                        <!--      <div class="numbertext">3 / 3</div>-->
                        <!--      <img src="https://devvsh.deskohome.com/public/assets/img/payment3.jpeg" style="width:30%">-->
...
var options = {
    ...
    "image": "https://devvsh.deskohome.com/public/assets/img/desko_logo.webp",
    // "image": "https://devvsh.deskohome.com/public/assets/img/desko_logo.webp,
    // "order_id": "order_9A33XWu170gUtm",
    //This is a sample Order ID. Pass the `id` obtained in the response of Step 1
    "callback_url": "https://devvsh.deskohome.com/payment/payment.php?order_id=<?=$order_id?>",
    "prefill": {
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/desko2023/public_html/devvsh/resources/views/payment-method.blade.php ENDPATH**/ ?>