...
<div>
 <?php if(Session::get('success')): ?>
    ...
    <?php endif; ?>
										...
										<form action="<?php echo e(url('update_subject/'.$subject->sub_id)); ?>" method="post" enctype="multipart/form-data" >
										...
										<div class="row row-sm">
										    ...
										    <div class="form-floating mb-3">
											 <input type="text" value="<?php echo e($subject->sub_name); ?>" class="form-control" id="floatingInput" placeholder="name@example.com" name="subject_name">
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/cws/public_html/goodwill_academy/resources/views/edit_subject.blade.php ENDPATH**/ ?>