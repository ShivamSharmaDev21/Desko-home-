            ...
            <div class="row justify-content-center ht100">
             ...
             <div class="top_slider">
                  <div class="text1 desk small_desk active_desk" id="content-1">
                    ...
                    <?php $__currentLoopData = $desktops; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $top): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <div>
                          ...
                          <h5>Top Color</h5>
                           <div class="colorpicker top_color_first">
                            ...
                            <div class=""style="background-color:<?php echo e($colour_val->colour_value); ?>">
                              <label class="style_color top_active_input row<?=$i;?>_col<?=$j;?>" data_top_price="<?=$top->top_price;?>"  count_data="<?=count($desktops);?>" data-rel="#checkeds" >
                                <input type="radio" class="pickimg" name="top_colorradio" row_data="<?=$i?>" c_data="<?=$j?>" count_data="<?=count($desktops);?>" value="<?php echo e($top_clr->id); ?>">
                                <span ></span>
                              </label>
                            </div>
                        ...
                        <div class="manage-slide">
                               <?php $b=0; 	
                             $top_imges=DB::table('top_gallery')->orderBy('id','asc')->where('id','=',$top_gall_id)->select('*')->get(); 
                         ...
                         <?php $b++; } } ?>
                          ...
                          <!--  &nbsp;<i class="far fa-rupee-sign"></i><input name='total_desk_price' class="price-title" type="text" value="<?php echo e($top->top_price); ?>" readonly /></h3>-->
                          <!--</div>-->
                        </div>
                      </div>
                      <?php $i++;?>
                    ...
                    <!-- Footrest image -->
                     <div class="footrest_img">
                      <img src="<?php echo e(asset('public/assets/img/smart/_259Z.jpeg')); ?>">
                    </div>
              ...
              <!-- wheels image -->
                    ...
                    <?php $__currentLoopData = $deskbottoms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bot): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      ...
                      <div class="manage-slide-bottom">
                         <?php $c=0; 	
                             $bot_imges=DB::table('bottom_gallery')->orderBy('id','asc')->where('id','=',$bottom_gall_id)->select('*')->get(); 
                              ...
                              <?php $j=0; ?>
                                 ...
                                 <?php if (in_array($bot_clr->colour_id, $colour_arr))
                                  { $colour_value= App\Models\Colour::where('id',$bot_clr->colour_id)->first();
                                    //echo "<pre>"; echo($colour_val);die;
                                  ?>
                            <div class=""style="background-color:<?php echo e($colour_value->colour_value); ?>">
              ...
              <div class="col-lg-4 pricecontent">
                ...
                <button type="submit" class="btn btn-primary btn-size" style=""onclick='screenshot(event);'> <i class="fas fa-plus"></i></button>
        ...
        <div class="modal-dialog modal-dialog-centered" id="content-with">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="exampleModalLabel" style="color:#000;padding: 1rem;font-size: 22px;">What's included</h5>
...
<section class="warranty border-bottom">
                <div class="">
                    <div class="text-center">
                        ...
                        <span class="pt-3"><strong><p class="flag-p">Why buy from Atmosphere</p></strong></span>
                    </div>
                    <div class="card-d">
                        <div class="card-w">
                         <div class="warrnt-mg">
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/cws/public_html/deskohome/resources/views/flagship_workstations.blade.php ENDPATH**/ ?>