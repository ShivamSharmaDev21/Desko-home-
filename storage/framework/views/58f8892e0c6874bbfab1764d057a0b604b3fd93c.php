...
<?php echo $__env->make('include.google_tag_header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php echo $__env->make('include.google_ads', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <link href="admin/public/frontend/assets/css/lib/bootstrap.min.css" rel="stylesheet">
    <link href="admin/public/frontend/assets/css/plugins/font-awesome.min.css" rel="stylesheet">
    <link href="admin/public/frontend/assets/css/plugins/lineicons.css" rel="stylesheet">
    <link href="admin/public/vendors/owl-carousel/assets/owl.carousel.css" rel="stylesheet">
    <link href="admin/public/frontend/assets/css/plugins/animate.css" rel="stylesheet">
  <link rel="stylesheet" type="text/css" href="https://site-assets.fontawesome.com/releases/v5.15.4/css/all.css">
    <link href="admin/public/frontend/assets/css/style.css" rel="stylesheet">
    <link href="admin/public/frontend/assets/css/themes/blue-orange.css" rel="stylesheet">
   <style>
...
.is-scrolling .black-logo
{
    display : block !important;
}
.is-scrolling .white-logo
{
    display : none;
}
@media (max-width: 767px)
...
.wheels .indicator .plus-icon:after
{
     float: right !important;
    margin-left: 0; 
}
.wheels.show-cont .indicator .plus-icon:after {
    width: 64px !important;
}
.wheels.feature-note.show-cont .indicator .plus-icon.base:after {
    width: 64px !important;
}
...
.footer p, .footer h6, .text-center.p-4
{
            ...
            <div class="container-fluid">
                ...
                <div class="navbar-header">
                    <a class="navbar-brand" href="#header">
                        <img src="public/assets/img/desko_white.png" alt="logo" class="white-logo">
                        <img src="public/assets/img/desko_black.png" alt="logo" class="black-logo"></a>
...
<!--<div class="header-fixed-placeholder"></div>-->
    <main>
        ...
        <?php endif; ?>
        <section class="row the-hero danish_eid" style="background-image : url('admin/public/slider_image_home/<?php echo e($slider->image); ?>');
            ...
            <div class="container-fluid w-1001">
                <div class="row d-width">
                    <div class="col-lg-6 col5 wow fadeInDown" data-wow-delay="0.3s">
                        ...
                        <!--    class="btnshop pad-link mar-link"><?php echo e($slider->btn1_caption); ?></button>-->
                        <!--Customize-->
                        <!--<button type="button" onclick="location.href='<?php echo e($slider->btn2_link); ?>'"-->
                        <!--    class="btnshop buttonshop pad-link"><?php echo e($slider->btn2_caption); ?></button>-->
                         <button type="button" id="custom-button-id" onclick="location.href='https://deskohome.com/custom'"
                            class="btnshop buttonshop pad-link" style="margin: auto;"><?php echo e($slider->btn2_caption); ?></button>
        ...
        <section class="row the-product pb-0" id="product">
            <div class="container">
                ...
                <div class="row apple-watch-note-feature text-center">
                    ...
                    <img src="admin/public/frontend/assets/img/Plus-Sign.webp" alt="" width="80%">
<!--show-cont-->
                    ...
                    <div class="feature-note right wheels bottom wow fadeInUp">
                        <div class="indicator">
            ...
            <div class="container">
                ...
                <div class="row justify-content-center dflex">
                    <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="col-md-6 text-center hoverAni frontPageProductDiv">
                            <img src="admin/public/feature_image/<?php echo e($product->feature_image); ?>" id="product-image" class="wow fadeInDown my-fe"
                                data-wow-delay="0.3s" style="min-height: 389px">
                               
                                <h6 class="price-99"><span><s>&#8377;<?php echo e(number_format( $product->mrp_price , 0, '.', ',' )); ?></s></span></h6>
                                <h6><span class="price-del">&#8377;<?php echo e(number_format( $product->offer_price , 0, '.', ',' )); ?></span></h6>
                                <a href="<?php echo e(url('/Products')); ?>/<?php echo e($product->url); ?>" class="button-link wow fadeInUp" 
        ...
        <!--====== Contact Area End ======-->
        <!--Customize button in the middle of the home page , viedo and button -->
        <section id="partner-with-us partner-section" class="mb50 section alter3-features video-section contact-area video-top pb-0">
           <div class="">
                <div class="row justify-content-center d-flex">
                    <div class="col-12 col-md-12 col-lg-12">
                        <div class="section-heading text-center pb-0 mb-40">
                            <h2 class="text-capitalize">Introducing: Build Your Own Desk <br> As Suiting Your Profession, Age & Space</h2>
                        </div>
                    </div>
                </div>
                  
                <div class="row justify-content-center d-flex egarloading_subdiv " style="background: #2f3130; padding-bottom: 50px; padding-top: 50px; ">
                    
                </div>
                <div class="btngroup text-center">
                     <!--<a href="<?php echo e($video->btn_link); ?>" type="button" class="btnshop "><?php echo e($video->btn_caption); ?></a>-->
                    <a href="<?php echo e(url('/custom')); ?>" type="button" class="btnshop "><?php echo e($video->btn_caption); ?></a>
                </div>
        ...
        <!--====== Contact Area Start ======-->
         <section class="row left-right-contents mt-3" style="    margin-top: 3rem;background-image : url('admin/public/feature_image_home/<?php echo e($feature->image); ?>');
                ...
                <div class="row justify-content-center d-flex">
                    <div class="col-12 col-md-12 ">
                        ...
                        <div class="company-logo">
                            <img src="admin/public/frontend/assets/img/Company-Logos.webp" alt="" width="1100px"/>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <?php $__currentLoopData = $review; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <div class="card text-center rounded">
                                    <div class="row align-items-center d-flex">
                                        <div class="col-lg-6">
                                            <div class="box_frame"
                                                style="background-image: url('admin/public/review_image_home/<?php echo e($r->image); ?>');">
                                                <img src="admin/public/review_image_home/<?php echo e($r->image); ?>">
                        ...
                        <ul class="categories__product d-flex">
                            <li class="categories__product--list wow fadeInDown" data-wow-delay="0.1s">
                                <a class="categories__product--icons" href="#">
                                    <img src="admin/public/frontend/assets/img/icon1.png">
                            ...
                            <li class="categories__product--list wow fadeInUp" data-wow-delay="0.2s">
                                <a class="categories__product--icons" href="#">
                                    <img src="admin/public/frontend/assets/img/icon3.png">
                            ...
                            <li class="categories__product--list wow fadeInUp" data-wow-delay="0.3s">
                                <a class="categories__product--icons" href="#">
                                    <img src="admin/public/frontend/assets/img/icon2.png">
                            ...
                            <li class="categories__product--list wow fadeInUp" data-wow-delay="0.3s">
                                <a class="categories__product--icons" href="#">
                                    <img src="admin/public/frontend/assets/img/icon4.png">
                            ...
                            <li class="categories__product--list wow fadeInUp" data-wow-delay="0.4">
                                <a class="categories__product--icons" href="#">
                                    <img src="admin/public/frontend/assets/img/icon5.png">
                            ...
                            <li class="categories__product--list wow fadeInUp" data-wow-delay="0.5s">
                                <a class="categories__product--icons" href="#">
                                    <img src="admin/public/frontend/assets/img/icon6.png">
                            ...
                            <div class="banner__items position__relative">
                                <a class="banner__items--thumbnail" href="#">
                                    <img class="banner__items--thumbnail__img wow fadeInDown" data-wow-delay="0.3s"
                                        src="admin/public/frontend/assets/img/Desko-productivity.webp" alt="banner-img"
                        ...
                        <div class="row justify-content-center d-flex flex-top shad my-bott">
                            ...
                            <div class="col-md-7 p-0">
                                <div class="box-watch wow fadeInUp" data-wow-delay="0.3s">
                                    <img src="admin/public/msg_image_home/<?php echo e($m->image); ?>">
                                </div>
                            </div>
                        ...
                        <div class="row justify-content-center d-flex align-items-center shad my-bott">
                            ...
                            <div class="col-md-6 p-0">
                                <div class="wow fadeInDown" data-wow-delay="0.3s">
                                    <img src="admin/public/msg_image_home/<?php echo e($m->image); ?>" class="msg-home">
                                </div>
                            </div>
                        </div>
                    <?php endif; ?>
                            ...
                            <div class="card product-card text-center rounded">
                                ...
                                <div class="product-image">
                                    <img loading="lazy" class="product-thumb mx-auto pt-3"
                                        src="admin/public/feature_image/<?php echo e($product->feature_image); ?>" alt="">
                                </div>
                                <!-- Card Body -->
                                ...
                                <div class="product-order">
                                    ...
                                    <div class="order-btn d-flex flex-wrap justify-content-center">
                                        <a class="prolend-primary style-two m-2" href="<?php echo e(url('/Products')); ?>/<?php echo e($product->url); ?>"  >Shop Now</a>
                                    </div>
                                </div>
                            </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="container">
                ...
                <div class="row wow fadeInUp" data-wow-delay="0.5s">
                    <div class="col-12 ">
                        ...
                        <!--</table>-->
                        <div class="table-img">
                            <img src="admin/public/frontend/assets/img/DeskoComparative.webp" width="1180" >
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row justify-content-center d-flex">
                    <div class="col-12 col-md-10">
                        ...
                        <div class="contact-box text-center">
                            <!-- Contact Form -->
                           <form id="contact-form" method="POST" action="https://deskohome.com/contact-us-form">
                ...
                <div class="row section-header wow fadeInUp">
                    ...
                    <p>Got questions? We’ve got answers. If you have some other questions, feel free to send us an email
                        ...
                        <a href="#"><span class="__cf_email__"
                                data-cfemail="7c14191010133c0c0e1318091f08521f1311">getdesko@gmail.com
                            <!--[email&#160;protected]-->
                            </span></a>
                    </p>
                </div>
...
<footer class="text-center text-lg-start bg-light text-muted mt-3">
      ...
      <div class="row mt-3">
        ...
        <div class="col-md-3 col-lg-3 col-xl-3 mx-auto mb-4">
          ...
          <div class="navbar-header mb-5" style="width:100%">
              <div class="navbar-brand footer-nav" ><a href="<?php echo e(url('/')); ?>">
                  <img src="<?php echo e(URL::asset('public/assets/img/desko_logo.webp')); ?>" alt="Image" style="width: 110px; margin-top: -30px;"/></a></div></div>
        ...
        <div class="col-md-3 col-lg-3 col-xl-2 mx-auto mb-4">
          ...
          <p>
           <a href="<?php echo e(url('/privacy-policy')); ?>" class="text-reset">Privacy Policy</a>
          </p>
          <p>
            <a href="<?php echo e(url('/terms')); ?>" class="text-reset">Terms And Conditions</a>
          </p>
          <p>
            <a href="<?php echo e(url('/shipping')); ?>" class="text-reset">Shipping</a>
          </p>
          <p>
            <a href="<?php echo e(url('/refund')); ?>" class="text-reset">Refund</a>
          </p>
          
          <p>
            <a href="<?php echo e(url('/contact-us')); ?>" class="text-reset">Contact Us</a>
          </p>
        </div>
        <!-- Grid column -->
        ...
        122004
         ...
         <div class="flex-items">
              ...
              <p><i class="fas fa-envelope me-3 f-circle"></i></p>
               <p>getdesko@gmail.com</p></div>
         <div class="flex-items">
              <p><i class="fas fa-phone me-3 f-circle"></i> </p> <a href="tel:+919315966725"> +91 9315966725</a>
         </div>
  ...
  <!-- Copyright -->
    ...
    <!--<button onclick="topFunction()" id="myBtn"  class="back_to_top" title="Go to top"><img src="admin/public/images/back_to_top.png" alt="back to top"></button>-->
    <!--<a href="#header" class="back_to_top"></a>-->
    
    <!--<div class="float whatsappmsg">-->
    <!--    <a href="https://api.whatsapp.com/send?phone=919315966725" class=" d-flex" target="_blank">-->
    <!--        <i class="fab fa-whatsapp my-float"></i>-->
    <!--        <div class="chat">-->
    <!--            <h5>Chat With Us</h5>-->
    <!--        </div>-->
    ...
    <!--<div class="float whatsappmsg">-->
    <!--    <a href="https://api.whatsapp.com/send?phone=919315966725" class=" d-flex"  id="aisensy-wa-widget" target="_blank">-->
    <!--        <i class="fab fa-whatsapp my-float"></i>-->
    <!--        <div class="chat">-->
    <!--            <h5>Chat With Us</h5>-->
    <!--        </div>-->
    ...
    <script src="admin/public/js/lib/jquery-2.2.0.min.js"></script>
    <script src="admin/public/js/lib/bootstrap.min.js"></script>
    <script src="admin/public/vendors/owl-carousel/owl.carousel.js"></script>
    <script src="admin/public/js/plugins/wow.min.js"></script>
...
<script>
    ...
    $(document).ready(function(){
     ...
     function youtuevied(){
         ...
         html = `<div class="col-12 col-md-10 text-center wow fadeInDown" data-wow-delay="0.3s">
            <iframe width="560" height="315"   
                src="https://www.youtube.com/embed/${url}?mute=1&autoplay=1"
...
<?php /**PATH /home/desko2023/public_html/resources/views/index_home.blade.php ENDPATH**/ ?>